...
- [You have set your Docker socket host to your local Lima-powered Kubernetes cluster](/docs/lima/creating-a-lima-instance) (optional).
...
- [Customizing the Lima instance for both containers and Kubernetes workloads](/docs/lima/customizing).
- You can build your image in your Lima instance, so that you don't need to push it!
- [nerdctl daemon](https://github.com/afbjorklund/nerdctld) (`nerdctl.sock` for containerd/buildkit)

  | Docker socket | Kubernetes interface  | Notes     |
  | ------------- | --------------------- | --------- |
  | nerdctl.sock  | containerd cri plugin | _Default_ |
  | docker.sock   | cri-dockerd           |           |
  | podman.sock   | cri-o                 |           |
