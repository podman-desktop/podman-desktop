...
When running Podman Desktop, when running as admin, you will be able to see HyperV Podman machines. When running in a non-privilaged mode, you should see your WSL Podman machines.
