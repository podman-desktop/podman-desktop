...
- **Allow to show images/gif using markdown**: Added support for displaying images and GIFs in markdown content ([#13518](https://github.com/podman-desktop/podman-desktop/issues/13518))
- **Implement updated design of notifications on the dashboard**: Updated dashboard notifications to match latest extension designs ([#13106](https://github.com/podman-desktop/podman-desktop/issues/13106))
- **UX: Updated dashboard design: Feature Discovery & learning**: Enhanced dashboard with feature discovery and learning capabilities ([#12239](https://github.com/podman-desktop/podman-desktop/issues/12239))
- **UX: Updated dashboard design: Issue detection and Resolution**: Improved dashboard issue detection and resolution workflows ([#12081](https://github.com/podman-desktop/podman-desktop/issues/12081))
- **Notify when we detect user has podman installed twice**: Added notification for duplicate Podman installations ([#12011](https://github.com/podman-desktop/podman-desktop/issues/12011))

#### Podman

- **Update podman to v.5.6**: Updated Podman to version 5.6 for enhanced features ([#13427](https://github.com/podman-desktop/podman-desktop/issues/13427))
...
- **Cannot build an image on Mac OS with X-Registry-Config header errors**: Fixed image building with invalid registry configurations ([#13061](https://github.com/podman-desktop/podman-desktop/issues/13061))
...
- fix: do not re-write registiries to auth.json if the values have not changed by @SoniaSandler in https://github.com/podman-desktop/podman-desktop/pull/13499
...
- test(renderer): try fix instability by clearing mock when unmounting by @eqqe in https://github.com/podman-desktop/podman-desktop/pull/13399
