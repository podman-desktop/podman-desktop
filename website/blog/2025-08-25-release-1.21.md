...
- **Support images and GIFs in Markdown**: Added support for displaying images and GIFs in Markdown content ([#13518](https://github.com/podman-desktop/podman-desktop/issues/13518))
...
- **UX: Feature discovery and learning**: Enhanced dashboard with feature discovery and learning capabilities ([#12239](https://github.com/podman-desktop/podman-desktop/issues/12239))
- **UX: Issue detection and resolution**: Improved dashboard issue detection and resolution workflows ([#12081](https://github.com/podman-desktop/podman-desktop/issues/12081))
