...
> TODO: take Charlie input and make something out of it
> - Create virtual machines with Macadam! Now supported on Linux and macOS, see the new virtual machine action button for testing your image locally.
> - Built-in support for virtual machine management. Under Resources > Settings see our new section on management your virtual machines.
> - More examples. See our new examples such as Kernel module management and using WiFi modules.
