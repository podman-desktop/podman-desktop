...
- **Bootc Extension 1.9**: ?? [^1][^2]
- **AI Lab 1.7.2**: AI Lab Openvino, MCP [^55]
- **Minc extension**: Podman Desktop extension to deploy MicroShift as container[^3]
- **RHEL lightspeed extension**: Podman Desktop extension to get assistance using RHEL Lightspeed.[^4]
- **RHEL VMs extension**: The RHEL VMs extension helps the user run RHEL Virtual machines.[^5]

[^1]: https://github.com/podman-desktop/extension-bootc/releases/tag/v1.9.1

[^2]: https://github.com/bootc-dev/bootc

[^3]: https://github.com/minc-org/minc-extension

[^4]: https://github.com/redhat-developer/podman-desktop-redhat-lightspeed-ext

[^5]: https://github.com/redhat-developer/podman-desktop-rhel-ext

## [^55]: https://github.com/containers/podman-desktop-extension-ai-lab/issues/2834#issuecomment-2901768123
...
> These motivate different engineering trade-offs for Kubernetes at the far edge than for cloud or near-edge scenarios.

https://www.redhat.com/en/topics/edge-computing/microshift

> The Red Hat® build of MicroShift is a lightweight Kubernetes container orchestration
> solution built from the edge capabilities of Red Hat® OpenShift® and based on the open source community’s project by the same name.

https://podman-desktop.io/blog/2024/11/08/bootc-microshift

> In this tutorial, we'll deploy an OpenShift derivative called MicroShift,
> an edge-optimized version of OpenShift designed for single-node setups on resource-constrained configurations.
> Think of it as a compact version of OpenShift!
