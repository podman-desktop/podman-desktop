...
- **Refining the Docker Compatibility feature**: The Docker Compatibility page has been moved out of experimental mode, and new supporting components such as podman-mac-helper and mac podman socket failures notifications have been added to help users set it up
...
- **Experimental statusbar providers enhancments**: Statusbar providers can be pinned and un-pinned based on user preferences and the provider status icons have been updated to be easier to understand
...
As part of our ongoing Kubernetes improvment and enhancement efforts, a new tab has been added for Kubernetes Jobs. You can now view the jobs, all in one place, with details page for each one, and have the ability to delete and view conditions statuses.
