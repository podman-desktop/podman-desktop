...
- refactor(tools): simplify vitest config by @axel7083 [12108](https://github.com/podman-desktop/podman-desktop/pull/12108)
- refactor(packages): simplify vitest config by @axel7083 [12104](https://github.com/podman-desktop/podman-desktop/pull/12104)
- refactor(extensions): simplify vitest config by @axel7083 [12103](https://github.com/podman-desktop/podman-desktop/pull/12103)
- refactor(Button): migrate to svelte5 by @axel7083 [12079](https://github.com/podman-desktop/podman-desktop/pull/12079)
- refactor: add ProviderConnection union type by @SoniaSandler [12045](https://github.com/podman-desktop/podman-desktop/pull/12045)
- refactor: component EngineFormPage to svelte 5 by @feloy [11981](https://github.com/podman-desktop/podman-desktop/pull/11981)
- refactor: migrate FormPage component to svelte 5 by @feloy [11972](https://github.com/podman-desktop/podman-desktop/pull/11972)
- refactor: use provider id instead of socket to index terminal info by @feloy [11926](https://github.com/podman-desktop/podman-desktop/pull/11926)
- refactor: extract code to a method + use async by @benoitf [11895](https://github.com/podman-desktop/podman-desktop/pull/11895)
- refactor: component DetailsPage to svelte 5 by @feloy [11889](https://github.com/podman-desktop/podman-desktop/pull/11889)
- refactor(podman): extract HyperVCheck class to dedicated file by @axel7083 [11865](https://github.com/podman-desktop/podman-desktop/pull/11865)
- refactor(podman): move hyperV related function inside classes by @axel7083 [11864](https://github.com/podman-desktop/podman-desktop/pull/11864)
- refactor: changed nullish ifs for nullish coalescing operator assignment by @gastoner [11847](https://github.com/podman-desktop/podman-desktop/pull/11847)
- refactor: provider-registry:create(Container|Kubernetes)ProviderConnection by @feloy [11809](https://github.com/podman-desktop/podman-desktop/pull/11809)
- refactor(ProviderWidget): split component in two by @axel7083 [11804](https://github.com/podman-desktop/podman-desktop/pull/11804)
- refactor(frontend): using string as key for proxy dropdown by @axel7083 [11771](https://github.com/podman-desktop/podman-desktop/pull/11771)
- refactor(status-bar): move providers logic to dedicated component by @axel7083 [11749](https://github.com/podman-desktop/podman-desktop/pull/11749)
- refactor(podman): extract VirtualMachinePlatformCheck class from `podman-install.ts` by @axel7083 [11743](https://github.com/podman-desktop/podman-desktop/pull/11743)
- refactor(podman): move `isVirtualMachineAvailable` function to `VirtalMachinePlatformCheck` class by @axel7083 [11727](https://github.com/podman-desktop/podman-desktop/pull/11727)
- refactor: rename docker compatibility setting info name by @SoniaSandler [11724](https://github.com/podman-desktop/podman-desktop/pull/11724)
- refactor(podman): group utils files by @axel7083 [11703](https://github.com/podman-desktop/podman-desktop/pull/11703)
- refactor(Dropdown): enforce string key by @axel7083 [11693](https://github.com/podman-desktop/podman-desktop/pull/11693)
- refactor(main): move `window-all-closed` listener to main class by @axel7083 [11468](https://github.com/podman-desktop/podman-desktop/pull/11468)
- refactor(main): classify protocol launcher logic by @axel7083 [11403](https://github.com/podman-desktop/podman-desktop/pull/11403)
