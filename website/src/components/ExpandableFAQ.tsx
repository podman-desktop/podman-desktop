...
export const ExpandableFAQ = (props: ExpandableFAQProps): JSX.Element => {
  ...
  return (
    <div>
      <button onClick={() => setExpanded(!expanded)} className="flex flex-row items-center justify-start gap-6 p-2.5">
      ...
      <div className="w-full h-1 dark:bg-white bg-gray-900"></div>
