...
import type { LayoutEditItem } from './LayoutManager.svelte';
import LayoutManager from './LayoutManager.svelte';

const mockItems: LayoutEditItem[] = [
  { id: 'item1', label: 'First Item', enabled: true, order: 0 },
  { id: 'item2', label: 'Second Item', enabled: true, order: 1 },
  { id: 'item3', label: 'Third Item', enabled: false, order: 2 },
  { id: 'item4', label: 'Fourth Item', enabled: true, order: 3 },
];
...
test('Expect dropdown closes with Escape key', async () => {
  render(LayoutManager, {
    items: mockItems,
    title: 'Manage Layout',
  });
...
test('Expect item toggle functionality works when enableToggle is true', async () => {
  ...
  const component = render(LayoutManager, {
    items: updatedItems,
    title: 'Manage Layout',
    enableToggle: true,
  });
...
test('Expect reset button is enabled when items are reordered', async () => {
  ...
  const originalItems = [
    { id: 'item1', label: 'First Item', enabled: true, order: 0 },
    { id: 'item2', label: 'Second Item', enabled: true, order: 1 },
    { id: 'item3', label: 'Third Item', enabled: true, order: 2 },
    { id: 'item4', label: 'Fourth Item', enabled: true, order: 3 },
  ];
  ...
  const reorderedItems = [
    { id: 'item2', label: 'Second Item', enabled: true, order: 0 },
    { id: 'item1', label: 'First Item', enabled: true, order: 1 },
    { id: 'item3', label: 'Third Item', enabled: true, order: 2 },
    { id: 'item4', label: 'Fourth Item', enabled: true, order: 3 },
  ];
