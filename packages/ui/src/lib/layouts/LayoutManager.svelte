...
import type { LayoutEditItem } from './LayoutManager';
...
<div class="relative inline-block {className}" bind:this={containerElement}>
  <button
    class="cursor-pointer text-[var(--pd-action-button-text)] hover:text-[var(--pd-action-button-hover-text)] transition-all duration-150 hover:scale-110 active:scale-95"
