...
import DevelopmentExtensionListTable from './DevelopmentExtensionListTable.svelte';
...
async function addLocalFolderExtension(): Promise<void> {
  ...
  const result = await window.openDialog({
    ...
    openLabel: 'Select this folder as extension folder',
    ...
    <div class="flex flex-col">
      ...
      <div class="bg-[var(--pd-content-bg)] rounded flex flex-col p-2">
        <div class="flex flex-row w-full">
          <div class="text font-medium first-letter:uppercase pb-2">Current local extension folders being tracked:</div>
