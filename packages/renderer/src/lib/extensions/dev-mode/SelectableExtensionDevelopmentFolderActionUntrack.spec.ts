...
import SelectableExtensionDevelopmentFolderActionUntrack from './SelectableExtensionDevelopmentFolderActionUntrack.svelte';
...
test('Expect untrack action being displayed if there is an extension', async () => {
  render(SelectableExtensionDevelopmentFolderActionUntrack, { extensionFolder: extensionFolderWithExtensionFound });
...
test('Expect untrack action being hidden if there is an extension', async () => {
  render(SelectableExtensionDevelopmentFolderActionUntrack, { extensionFolder: extensionFolderWithExtensionStarted });
  const untrackButton = screen.getByRole('button', { name: 'Untrack extension folder' });
  expect(untrackButton).toBeInTheDocument();
