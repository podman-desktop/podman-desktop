...
export const ViewContributionRecordSchema = z.record(z.string(), z.array(ViewContributionSchema));

export type ViewContributionRecord = z.output<typeof ViewContributionRecordSchema>;
