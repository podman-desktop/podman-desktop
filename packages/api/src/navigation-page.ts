...
export enum NavigationPage {
  ...
  KUBERNETES_INGRESSES = 'kubernetes-ingresses',
  KUBERNETES_INGRESS = 'kubernetes-ingress',
  KUBERNETES_ROUTES = 'kubernetes-routes',
  KUBERNETES_ROUTE = 'kubernetes-route',
  KUBERNETES_CONFIGMAPS = 'kubernetes-configmaps',
