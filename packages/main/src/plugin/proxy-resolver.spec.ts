...
test.each<GetProxyUrlTestCase>([
  ...
  // IPv6 with port (use non-loopback addresses — ::1 always bypasses)
  {
    description: 'matches IPv6 with port [fe80::1]:8080',
    noProxy: '[fe80::1]:8080',
    host: 'fe80::1',
    port: '8080',
    expected: undefined,
  ...
  {
    description: 'uses proxy for IPv6 with non-matching port [fe80::1]:8080 vs 9090',
    noProxy: '[fe80::1]:8080',
    host: 'fe80::1',
    port: '9090',
    expected: HttpsProxyUrl,
  ...
  {
    description: 'uses proxy for IPv6 with port when request has no port',
    noProxy: '[fe80::1]:8080',
    host: 'fe80::1',
    port: undefined,
    expected: HttpsProxyUrl,
  ...
  {
    description: 'matches full IPv6 with port [fd00::1]:443',
    noProxy: '[fd00::1]:443',
    host: 'fd00::1',
    port: '443',
    expected: undefined,
  ...
  {
    description: 'uses proxy for full IPv6 with port on wrong port',
    noProxy: '[fd00::1]:443',
    host: 'fd00::1',
    port: '80',
    expected: HttpsProxyUrl,
  ...
  {
    description: 'matches expanded IPv6 with port [2001:db8::1]:3000',
    noProxy: '[2001:db8::1]:3000',
    host: '2001:db8::1',
    port: '3000',
    expected: undefined,
  },
  {
    description: 'bypasses IPv6 without port regardless of request port',
    noProxy: 'fd00::1',
    host: 'fd00::1',
    port: '9999',
    expected: undefined,
  ...
  {
    description: 'matches IPv6 with port in mixed list',
    noProxy: 'example.com,[fd00::1]:8080,10.0.0.0/8',
    host: 'fd00::1',
    port: '8080',
    expected: undefined,
  },
  {
    description: 'uses proxy for IPv6 with wrong port in mixed list',
    noProxy: 'example.com,[fd00::1]:8080,10.0.0.0/8',
    host: 'fd00::1',
    port: '443',
    expected: HttpsProxyUrl,
  },
  // Bracketed IPv6 without port — splitHostPort else branch (no colon after ])
  {
    description: 'matches bracketed [fd00::1] without port in noProxy',
    noProxy: '[fd00::1]',
    host: 'fd00::1',
    port: undefined,
    expected: undefined,
  ...
  {
    description: 'matches bracketed [fd00::1] without port when request has port',
    noProxy: '[fd00::1]',
    host: 'fd00::1',
    port: '8080',
    expected: undefined,
  ...
  {
    description: 'uses proxy when bracketed [fd00::1] does not match host',
    noProxy: '[fd00::1]',
    host: 'fd00::2',
    port: undefined,
    expected: HttpsProxyUrl,
  ...
  {
    description: 'matches bracketed [2001:db8::1] without port in mixed list',
    noProxy: 'example.com,[2001:db8::1],10.0.0.0/8',
    host: '2001:db8::1',
    port: '443',
    expected: undefined,
  },
...
test('matchNoProxyRules returns false for empty hostname regardless of rules', () => {
  expect(matchNoProxyRules('', undefined, [])).toBe(false);
  expect(matchNoProxyRules('', undefined, parseNoProxy('example.com,.internal.local'))).toBe(false);
  expect(matchNoProxyRules('', undefined, parseNoProxy('192.168.1.1,10.0.0.0/8'))).toBe(false);
