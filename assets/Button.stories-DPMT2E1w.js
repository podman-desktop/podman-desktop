import{k as j,f as O,o as G,b as i,p as H,c as e,d as q,g as _,e as Y,j as c,r as s,s as A,i as E,t as $,a as b,h as f,l as L}from"./iframe-aTtlP2fM.js";import{c as J,i as Q,d as X}from"./create-runtime-stories-DbJFRlAo.js";import{f as K}from"./index-l4C1ahnl.js";import{b as m,c as V,a as I,d as R,e as Z,g as F,h as aa,i as x,j as na,k as ta}from"./Icon-CZ0lohKq.js";import{B as D}from"./Button-BQXxOHKN.js";import{e as ea}from"./each-yK1wA1RR.js";import"./preload-helper-PPVm8Dsz.js";const{fn:sa}=__STORYBOOK_MODULE_TEST__,ra=(h,k)=>{let n=()=>Y(k?.(),[]);var l=j(),v=O(l);{var u=t=>{var a=ya(),d=c(a),g=c(d),W=c(g,!0);s(g);var p=e(g,2);ea(p,5,()=>T[n().kind].variants,B=>B.name,(B,C)=>{var P=ua(),S=c(P),U=c(S,!0);s(S);var z=e(S,2);D(z,A(()=>L(C).args,{children:(N,xa)=>{E();var w=$();b(()=>f(w,L(C).args.content)),i(N,w)},$$slots:{default:!0}})),s(P),b(()=>f(U,L(C).name)),i(B,P)}),s(p),s(d),s(a),b(()=>f(W,T[n().kind].label)),i(t,a)},y=t=>{var a=ba(),d=c(a);D(d,A(n,{children:(g,W)=>{E();var p=$();b(()=>f(p,n().content)),i(g,p)},$$slots:{default:!0}})),s(a),i(t,a)};G(v,t=>{n().kind&&T[n().kind]?t(u):t(y,-1)})}i(h,l)},ia=sa().mockName("onclick"),oa={component:D,render:ra,title:"Button/Button",tags:["autodocs"],argTypes:{kind:{table:{disable:!0}}},args:{onclick:ia},parameters:{docs:{description:{component:`These are the stories for the \`Button\` component.
