"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[70876],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_extensions_developing_onboarding_workflow_md_686_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-extensions-developing-onboarding-workflow-md-686.json
const site_docs_extensions_developing_onboarding_workflow_md_686_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"extensions/developing/onboarding-workflow","title":"Onboarding workflow","description":"Podman Desktop onboarding workflow reference","source":"@site/docs/extensions/developing/onboarding-workflow.md","sourceDirName":"extensions/developing","slug":"/extensions/developing/onboarding-workflow","permalink":"/docs/extensions/developing/onboarding-workflow","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/extensions/developing/onboarding-workflow.md","tags":[{"inline":true,"label":"podman-desktop","permalink":"/docs/tags/podman-desktop"},{"inline":true,"label":"extension","permalink":"/docs/tags/extension"},{"inline":true,"label":"writing","permalink":"/docs/tags/writing"},{"inline":true,"label":"onboarding","permalink":"/docs/tags/onboarding"}],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1,"title":"Onboarding workflow","description":"Podman Desktop onboarding workflow reference","tags":["podman-desktop","extension","writing","onboarding"],"keywords":["podman desktop","extension","writing","onboarding"]},"sidebar":"mySidebar","previous":{"title":"Developing","permalink":"/docs/extensions/developing/"},"next":{"title":"When clause contexts","permalink":"/docs/extensions/developing/when-clause-context"}}');
// EXTERNAL MODULE: ../node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(62540);
// EXTERNAL MODULE: ../node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(43023);
;// ./docs/extensions/developing/onboarding-workflow.md
...
const toc = [{
  "value": "Title, Description and Media",
  "id": "title-description-and-media",
  "level": 3
}, {
  "value": "Enablement",
  "id": "enablement",
  ...
  "value": "Title, description and media",
  "id": "title-description-and-media-1",
  "level": 4
}, {
  "value": "Command",
  "id": "command",
...
function _createMdxContent(props) {
  ...
  return (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [(0,jsx_runtime.jsx)(_components.header, {
      ...
      children: "A Podman Desktop extension can offer an onboarding workflow to guide users in installing and setting up all the necessary tools for the extension to work, and optionally to provide explanations about the capabilities of the extension."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Adding onboarding to an extension is as simple as writing JSON in the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "package.json"
      }), ". Podman Desktop will convert the JSON object into actual code to render all items."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Onboarding consists of a title, a description, media (image), an enablement clause, and a list of steps. Only the title, enablement clause, and the steps are mandatory, as they constitute the minimum information required to define a workflow.\nBefore getting into the details, let's examine the JSON schema."
      ...
      id: "title-description-and-media",
      children: "Title, Description and Media"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: "media"
      }), " are all placed in the top left of the onboarding page.\nOnly the title is required. The description and the media are optional.\nIf the media is not specified, Podman Desktop will display the default icon set by the extension in its ", (0,jsx_runtime.jsx)(_components.code, {
        children: "package.json"
      }), "."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "This is how this JSON is defined:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
        children: "\"icon\": \"icon.png\",\n...\n\"onboarding\": {\n    \"title\": \"Podman Setup\",\n}\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img0",
        src: (__webpack_require__(76534)/* ["default"] */ .A) + "",
        width: "1535",
        height: "983"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      ...
      children: "The enablement clause allows Podman Desktop to determine when the onboarding should be enabled.\nWhen this condition is met, the user will find a setup button within the resources page. Clicking on it will initiate the onboarding workflow."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img1",
        src: (__webpack_require__(66478)/* ["default"] */ .A) + "",
        width: "1602",
        height: "1010"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The enablement clause is mandatory and must be written by using ", (0,jsx_runtime.jsx)(_components.a, {
        href: "/docs/extensions/developing/when-clause-context",
        children: "when clauses"
      }), "."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["In the following example, we specify that the onboarding needs to be enabled if and only if the user's OS is Linux, and the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "podmanIsNotInstalled"
      }), " context value is true. Alternatively, if the user's OS is different from Linux, that the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "podmanMachineExists"
      ...
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
        children: "\"enablement\": \"(isLinux && onboardingContext:podmanIsNotInstalled) || (!isLinux && !onboardingContext:podmanMachineExists)\"\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h3, {
      id: "steps",
      children: "Steps"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "The steps property is required and includes the actual content that will be displayed to the user during the workflow."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Each step can contribute to the onboarding process in various ways.\nYou can choose to display content explaining concepts to the user, incorporate input elements (such as buttons or textboxes) to encourage user interaction, run commands to perform installations, or showcase settings to be configured."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Let's look again at its schema:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
      ...
      children: "A step has only two mandatory fields - id and title. All other properties are optional."
      ...
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "id"
      }), " must be unique to identify a step, and it is never displayed directly to the user."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["To analyze more easily in telemetry the steps executed by users, the ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "id"
      }), " values must respect some rules.\nTo help developers respect these rules, a warning is displayed in case of non-repsect when Podman Destop loads the onboarding."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "The rules are:"
    }), "\n", (0,jsx_runtime.jsxs)(_components.ul, {
      children: ["\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["for a step defining a command, the id must terminate with ", (0,jsx_runtime.jsx)(_components.code, {
          children: "Command"
        }), ","]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["for a state defining ", (0,jsx_runtime.jsx)(_components.code, {
          children: "state='failed'"
        }), ", the id must terminate with ", (0,jsx_runtime.jsx)(_components.code, {
          children: "Failure"
        }), ","]
      }), "\n", (0,jsx_runtime.jsxs)(_components.li, {
        children: ["for a state defining ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: ["for any other step, the id must termminate with ", (0,jsx_runtime.jsx)(_components.code, {
          children: "View"
        }), "."]
      }), "\n"]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      ...
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: "media"
      }), " works as explained earlier. The only difference is their placement - they will appear in the top-center of the body."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img2",
        src: (__webpack_require__(62139)/* ["default"] */ .A) + "",
        width: "1539",
        height: "981"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.strong, {
        children: "Note:"
      }), " If media is not specified, Podman Desktop will display the icon of the extension providing the onboarding."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "command",
      children: "Command"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "command"
      }), " field allows you to declare the name of a command that must be run when the step becomes active.\nThe command must be registered by the extension beforehand, or it will result in an error."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["In the example below, we tell Podman Desktop to call ", (0,jsx_runtime.jsx)(_components.code, {
        children: "podman.onboarding.checkPodmanInstalled"
      }), " when the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "checkPodmanInstalled"
      ...
      children: "During the execution of the command, the user will see a spinner next to the title."
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img3",
        src: (__webpack_require__(27974)/* ["default"] */ .A) + "",
        width: "1536",
        height: "972"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "completionevents",
      children: "CompletionEvents"
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "CompletionEvents define the conditions under which a step should be considered complete."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["It currently supports ", (0,jsx_runtime.jsx)(_components.code, {
        children: "onboardingContext"
      }), " and ", (0,jsx_runtime.jsx)(_components.code, {
        children: "onCommand"
      }), " events.\nThe former can be used to evaluate a context value, such as ", (0,jsx_runtime.jsx)(_components.code, {
        children: "onboardingContext:podmanIsInstalled"
      }), ". The latter checks if the command has been executed - ", (0,jsx_runtime.jsx)(_components.code, {
        children: "onCommand:podman.onboarding.installPodman"
      }), "."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "A practical example of progressing the user to the next step after the command finishes its execution is:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
      ...
      children: ["When the ", (0,jsx_runtime.jsx)(_components.code, {
        children: "checkPodmanInstalled"
      }), " step becomes active, the command ", (0,jsx_runtime.jsx)(_components.code, {
        children: "podman.onboarding.checkPodmanInstalled"
      }), " is invoked. Upon completion of its execution, the step is considered complete, and the user is then moved to the next one."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "Here's another example, this time using a context value:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
      ...
      children: ["When the ", (0,jsx_runtime.jsx)(_components.code, {
        ...
        children: "podman.onboarding.checkPodmanInstalled"
      }), " is invoked. As soon as the context value ", (0,jsx_runtime.jsx)(_components.code, {
        children: "podmanVersion"
      }), " equals ", (0,jsx_runtime.jsx)(_components.code, {
        children: "4.7.2"
      }), ", the step is marked as completed, and the user is moved to the next one."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["You might wonder: who or what sets the context value? If you use a custom context value, it should be your extension's job to set it. Following the example above, we could set the context value during the execution of ", (0,jsx_runtime.jsx)(_components.code, {
        children: "podman.onboarding.checkPodmanInstalled"
      }), " such as"]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-js",
        children: "extensionApi.commands.registerCommand(\n    'podman.onboarding.checkPodmanInstalled',\n    async () => {\n      // do something\n      ...\n      // set podmanVersion context value so we can mark the step as complete\n      extensionApi.context.setValue('podmanVersion', '4.7.2', 'onboarding');\n    }\n)\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "After updating the context, the UI is refreshed, and Podman Desktop moves the user to the new step."
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "content",
      children: "Content"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "content"
      }), " property is an array of arrays where each item in the parent array defines a row, and each item in the child arrays defines a cell."]
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-js",
        children: "content = [\n  ['cell', 'cell'], //row\n  ['cell', 'cell', 'cell'], //row\n];\n"
      ...
      children: "The JSON schema for a content cell entry is"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
        children: "\"type\": \"object\",\n\"properties\": {\n    \"value\": {\n        \"type\": \"string\"\n    },\n    \"highlight\": {\n        \"type\": \"boolean\"\n    },\n    \"when\": {\n        \"type\": \"string\"\n    }\n},\n\"required\": [\"value\"]\n"
      ...
      children: [(0,jsx_runtime.jsx)(_components.strong, {
        children: "Value"
      }), " is the only mandatory field and it can be a simple string or a Markdown string to render advanced objects."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "In addition to all the standard Markdown syntax, Podman Desktop provides 3 custom Markdown components: button, link, and warnings list."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["1 - You can create a button that executes a command (syntax - ", (0,jsx_runtime.jsx)(_components.code, {
        children: ":button[Name of the button]{command=command.example title=\"tooltip text\"}"
      }), ") or behaves like a link (syntax - ", (0,jsx_runtime.jsx)(_components.code, {
        children: ":button[Name of the button]{href=http://my-link title=\"tooltip text\"}"
      }), ")."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "E.g.:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
        children: "\"value\": \":button[Check requirements again]{command=podman.onboarding.checkPodmanRequirements}\"\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img4",
        src: (__webpack_require__(39098)/* ["default"] */ .A) + "",
        width: "912",
        height: "236"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["2 - Similarly, you can create a link that executes a command (syntax ", (0,jsx_runtime.jsx)(_components.code, {
        children: ":link[Name of the command link]{command=command.example title=\"tooltip text\"}"
      }), ") or behaves like a normal link (syntax - ", (0,jsx_runtime.jsx)(_components.code, {
        children: ":link[Name of the command link]{href=http://my-link title=\"tooltip text\"}"
      }), ")"]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "E.g.:"
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
        children: "\"value\": \"To install Podman please follow these :link[installation instructions]{href=https://podman.io/docs/installation#installing-on-linux}\"\n"
      })
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img5",
        src: (__webpack_require__(43618)/* ["default"] */ .A) + "",
        width: "613",
        height: "335"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["3 - The warning component allows displaying a list of items (syntax - ", (0,jsx_runtime.jsx)(_components.code, {
        children: ":warnings[[item]]"
      ...
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        ...
        children: "when"
      }), " properties are optional. They are used to change the background color or define when the content column should be visible."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "component",
      children: "Component"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Podman Desktop has some built-in components that can fit perfectly into an onboarding workflow, such as the ", (0,jsx_runtime.jsx)(_components.code, {
      ...
      children: "By specifying the component you want to import, all the elements, styling, and actions are embedded into the step."
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Currently, Podman Desktop only supports two types of components for onboarding: ", (0,jsx_runtime.jsx)(_components.code, {
        children: "createContainerProviderConnection"
      }), " and ", (0,jsx_runtime.jsx)(_components.code, {
        children: "createKubernetesProviderConnection"
      }), "."]
    }), "\n", (0,jsx_runtime.jsx)(_components.p, {
      children: "An example can be seen in the Podman extension, where you can create a Podman machine during the workflow."
    }), "\n", (0,jsx_runtime.jsx)(_components.pre, {
      children: (0,jsx_runtime.jsx)(_components.code, {
        className: "language-json",
      ...
      children: (0,jsx_runtime.jsx)(_components.img, {
        alt: "img7",
        src: (__webpack_require__(17386)/* ["default"] */ .A) + "",
        width: "1517",
        height: "1001"
      })
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.strong, {
        children: "Note:"
      }), " when using the ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "component"
      }), " field, you should omit the ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "content"
      })]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "when",
      ...
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "when"
      }), " property defines when a step must be visible. You can use any when clause, and Podman Desktop will evaluate it any time the context changes."]
    }), "\n", (0,jsx_runtime.jsx)(_components.h4, {
      id: "state",
      children: "State"
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["The ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "state"
      }), ", when set, allows Podman Desktop to distinguish a normal step from a special one. It is used to associate a step with a failed state (", (0,jsx_runtime.jsx)(_components.code, {
        children: "failed"
      }), ") or, alternatively, with a complete state (", (0,jsx_runtime.jsx)(_components.code, {
        children: "completed"
      }), ")."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: [(0,jsx_runtime.jsx)(_components.strong, {
        children: "Note:"
      }), " the last workflow step should have ", (0,jsx_runtime.jsx)(_components.code, {
        children: "completed"
      }), " state."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["Based on the ", (0,jsx_runtime.jsx)(_components.strong, {
        children: "state"
      }), ", Podman Desktop might show some default objects."]
    }), "\n", (0,jsx_runtime.jsxs)(_components.p, {
      children: ["When a step with a failed state is encountered, Podman Desktop displays a ", (0,jsx_runtime.jsx)(_components.code, {
        children: "Retry"
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/component_field-f5365284785944953339f77e4f63050e.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/link_micromark-054caad1549f752aff722890fb11be7c.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/setup_button-71362a4db9503ffb2fd2ae5b569112d5.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/spinner_title-1bcdcb7a4b920917f5b9dc93d945da28.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/step_title_description_media-185a47edbda6dd96d333a8d4a8b763be.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/title_media_description-9afd3b427798bb088d84d412a20f1222.png");
...
/* harmony export */   A: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (__webpack_require__.p + "assets/images/warnings_micromark-0346d6cb229d20bd85d4eae552a91b31.png");
