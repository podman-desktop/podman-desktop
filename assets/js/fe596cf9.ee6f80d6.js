"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[89068],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_containers_registries_index_mdx_fe5_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-containers-registries-index-mdx-fe5.json
const site_docs_containers_registries_index_mdx_fe5_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"containers/registries/index","title":"Registries","description":"Working with container registries","source":"@site/docs/containers/registries/index.mdx","sourceDirName":"containers/registries","slug":"/containers/registries/","permalink":"/docs/containers/registries/","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/containers/registries/index.mdx","tags":[{"inline":true,"label":"podman-desktop","permalink":"/docs/tags/podman-desktop"},{"inline":true,"label":"containers","permalink":"/docs/tags/containers"}],"version":"current","sidebarPosition":3,"frontMatter":{"sidebar_position":3,"title":"Registries","description":"Working with container registries","tags":["podman-desktop","containers"],"keywords":["podman desktop","podman","containers","registries"],"hide_table_of_contents":false,"image":"/img/docs/containers/registries/img/registries.png"},"sidebar":"mySidebar","previous":{"title":"Onboarding for containers","permalink":"/docs/containers/onboarding"},"next":{"title":"Configuring a mirror registry","permalink":"/docs/containers/registries/configuring-mirror-registries"}}');
...
;// ./docs/containers/registries/index.mdx
