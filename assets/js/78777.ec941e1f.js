(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[78777],{
...
var Translate = __webpack_require__(6590);
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63696);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11750);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(62540);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlockButton({className,...props}){return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("button",{type:"button",...props,className:(0,clsx__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)('clean-btn',className)});}
...
var codeBlockUtils = __webpack_require__(91629);
// EXTERNAL MODULE: ../node_modules/@docusaurus/theme-classic/lib/theme/CodeBlock/Buttons/Button/index.js
var Button = __webpack_require__(84341);
// EXTERNAL MODULE: ../node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(62540);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"copyButtonCopied":"copyButtonCopied_WAFi","copyButtonIcons":"copyButtonIcons_Fy7c","copyButtonIcon":"copyButtonIcon_r1h_","copyButtonSuccessIcon":"copyButtonSuccessIcon_BIMv"});
...
const{default:copy}=await __webpack_require__.e(/* import() */ 23754).then(__webpack_require__.bind(__webpack_require__, 23754));return copy(text);}function useCopyButton(){const{metadata:{code}}=(0,codeBlockUtils/* useCodeBlockContext */.Ph)();const[isCopied,setIsCopied]=(0,react.useState)(false);const copyTimeout=(0,react.useRef)(undefined);const copyCode=(0,react.useCallback)(()=>{copyToClipboard(code).then(()=>{setIsCopied(true);copyTimeout.current=window.setTimeout(()=>{setIsCopied(false);},1000);});// Errors are intentionally not caught so they remain unhandled and can
// be captured by observability tools (e.g. Sentry, PostHog).
},[code]);(0,react.useEffect)(()=>()=>window.clearTimeout(copyTimeout.current),[]);return{copyCode,isCopied};}function CopyButton({className}){const{copyCode,isCopied}=useCopyButton();return/*#__PURE__*/(0,jsx_runtime.jsx)(Button/* default */.A,{"aria-label":ariaLabel(isCopied),title:title(),className:(0,clsx/* default */.A)(className,styles_module.copyButton,isCopied&&styles_module.copyButtonCopied),onClick:copyCode,children:/*#__PURE__*/(0,jsx_runtime.jsxs)("span",{className:styles_module.copyButtonIcons,"aria-hidden":"true",children:[/*#__PURE__*/(0,jsx_runtime.jsx)(IconCopy,{className:styles_module.copyButtonIcon}),/*#__PURE__*/(0,jsx_runtime.jsx)(IconSuccess,{className:styles_module.copyButtonSuccessIcon})]})});}
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"iconEdit":"iconEdit_bHB7"});
// EXTERNAL MODULE: ../node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(62540);
...
var IntlUtils = __webpack_require__(51636);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const EditMetaRow_styles_module = ({"lastUpdated":"lastUpdated_ydrU","noPrint":"noPrint_QeZL"});
...
var Head = __webpack_require__(57854);
// EXTERNAL MODULE: ../node_modules/@docusaurus/core/lib/client/exports/useIsBrowser.js
var useIsBrowser = __webpack_require__(86681);
// EXTERNAL MODULE: ../node_modules/clsx/dist/clsx.mjs
var clsx = __webpack_require__(11750);
// EXTERNAL MODULE: ../node_modules/@docusaurus/theme-common/lib/contexts/colorMode.js
var contexts_colorMode = __webpack_require__(72363);
// EXTERNAL MODULE: ../node_modules/@docusaurus/theme-common/lib/utils/useThemeConfig.js
var useThemeConfig = __webpack_require__(27412);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"codeBlockContainer":"codeBlockContainer_mQmQ"});
// EXTERNAL MODULE: ../node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(62540);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function CodeBlockContainer({as:As,...props}){const prismTheme=usePrismTheme();const prismCssVariables=(0,codeBlockUtils/* getPrismCssVariables */.M$)(prismTheme);return/*#__PURE__*/(0,jsx_runtime.jsx)(As// Polymorphic components are hard to type, without `oneOf` generics
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Content_styles_module = ({"codeBlock":"codeBlock_RMoD","codeBlockStandalone":"codeBlockStandalone_wQog","codeBlockLines":"codeBlockLines_AclH","codeBlockLinesWithNumbering":"codeBlockLinesWithNumbering_O625"});
...
var reactUtils = __webpack_require__(15198);
...
var dist = __webpack_require__(27663);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Line_styles_module = ({"codeLine":"codeLine_FAqz","codeLineNumber":"codeLineNumber_BE9Z","codeLineContent":"codeLineContent_EF2y"});
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const WordWrapButton_styles_module = ({"wordWrapButtonIcon":"wordWrapButtonIcon_CQkQ","wordWrapButtonEnabled":"wordWrapButtonEnabled_rYrY"});
...
function CodeBlockButtons({className}){return/*#__PURE__*/(0,jsx_runtime.jsx)(BrowserOnly/* default */.A,{children:()=>/*#__PURE__*/(0,jsx_runtime.jsxs)("div",{className:(0,clsx/* default */.A)(className,Buttons_styles_module.buttonGroup),children:[/*#__PURE__*/(0,jsx_runtime.jsx)(WordWrapButton,{}),/*#__PURE__*/(0,jsx_runtime.jsx)(CopyButton/* default */.A,{})]})});}
;// ../node_modules/@docusaurus/theme-classic/lib/theme/CodeBlock/Layout/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const Layout_styles_module = ({"codeBlockContent":"codeBlockContent_t_Hd","codeBlockTitle":"codeBlockTitle_kY6l","codeBlock":"codeBlock_I0F0"});
...
function CodeBlockString(props){const metadata=useCodeBlockMetadata(props);const wordWrap=useCodeWordWrap();return/*#__PURE__*/(0,jsx_runtime.jsx)(codeBlockUtils/* CodeBlockContextProvider */.l8,{metadata:metadata,wordWrap:wordWrap,children:/*#__PURE__*/(0,jsx_runtime.jsx)(CodeBlockLayout,{})});}
...
var anchorUtils = __webpack_require__(82809);
...
var useBrokenLinks = __webpack_require__(2041);
// EXTERNAL MODULE: ../node_modules/@docusaurus/theme-common/lib/components/Collapsible/index.js
var Collapsible = __webpack_require__(32432);
;// ../node_modules/@docusaurus/theme-common/lib/components/Details/styles.module.css
// extracted by mini-css-extract-plugin
/* harmony default export */ const Details_styles_module = ({"details":"details_IpIu","isBrowser":"isBrowser_QD4r","collapsibleContent":"collapsibleContent_Fd2D"});
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const theme_Details_styles_module = ({"details":"details_jERq"});
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Ul_styles_module = ({"containsTaskList":"containsTaskList_QWGu"});
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Img_styles_module = ({"img":"img_SS3x"});
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */async function loadMermaidAndRegisterLayouts(){const mermaid=(await __webpack_require__.e(/* import() */ 93721).then(__webpack_require__.bind(__webpack_require__, 93721))).default;// Mermaid does not support ELK layouts by default
...
return (0,react.useState)(`mermaid-svg-${Math.round(Math.random()*10000000)}`)[0];}async function renderMermaid({id,text,config}){const mermaid=await loadMermaid();/*
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const Mermaid_styles_module = ({"container":"container_U0RM"});
...
/* harmony import */ var _theme_MDXComponents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(46774);
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */function MDXContent({children}){return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__.jsx)(_mdx_js_react__WEBPACK_IMPORTED_MODULE_1__/* .MDXProvider */ .x,{components:_theme_MDXComponents__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A,children:children});}
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63696);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11750);
/* harmony import */ var _docusaurus_Link__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(45968);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(62540);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const styles_module = ({"tags":"tags_Ow0B","tag":"tag_DFxh"});
// EXTERNAL MODULE: ../node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(62540);
...
/* harmony import */ var _docusaurus_useDocusaurusContext__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67032);
/**
 * Copyright (c) Facebook, Inc. and its affiliates.
 *
 * This source code is licensed under the MIT license found in the
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(63696);
/* harmony import */ var clsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11750);
/* harmony import */ var parse_numeric_range__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19934);
/* harmony import */ var parse_numeric_range__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(parse_numeric_range__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _reactUtils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(15198);
...
if(metastring&&metastringLinesRangeRegex.test(metastring)){const linesRange=metastring.match(metastringLinesRangeRegex).groups.range;if(magicComments.length===0){throw new Error(`A highlight range has been given in code block's metastring (\`\`\` ${metastring}), but no magic comment config is available. Docusaurus applies the first magic comment entry's className for metastring ranges.`);}const metastringRangeClassName=magicComments[0].className;const lines=parse_numeric_range__WEBPACK_IMPORTED_MODULE_2___default()(linesRange).filter(n=>n>0).map(n=>[n-1,[metastringRangeClassName]]);return{lineClassNames:Object.fromEntries(lines),code};}return null;}function parseCodeLinesFromContent(code,params){const{language,magicComments}=params;if(language===undefined){return{lineClassNames:{},code};}const directiveRegex=getAllMagicCommentDirectiveStyles(language,magicComments);// Go through line by line
...
const value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useMemo)(()=>{return{metadata,wordWrap};},[metadata,wordWrap]);return/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_4__.jsx)(CodeBlockContext.Provider,{value:value,children:children});}function useCodeBlockContext(){const value=(0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(CodeBlockContext);if(value===null){throw new _reactUtils__WEBPACK_IMPORTED_MODULE_3__/* .ReactContextError */ .dV('CodeBlockContextProvider');}return value;}
