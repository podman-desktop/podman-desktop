"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[17001],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_configuration_managed_configuration_use_cases_mdx_a54_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-configuration-managed-configuration-use-cases-mdx-a54.json
const site_docs_configuration_managed_configuration_use_cases_mdx_a54_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"configuration/managed-configuration-use-cases","title":"Managed configuration use cases","description":"Common use cases and examples for enterprise managed configuration.","source":"@site/docs/configuration/managed-configuration-use-cases.mdx","sourceDirName":"configuration","slug":"/configuration/managed-configuration-use-cases","permalink":"/docs/configuration/managed-configuration-use-cases","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/configuration/managed-configuration-use-cases.mdx","tags":[{"inline":true,"label":"podman-desktop","permalink":"/docs/tags/podman-desktop"},{"inline":true,"label":"configuration","permalink":"/docs/tags/configuration"},{"inline":true,"label":"enterprise","permalink":"/docs/tags/enterprise"},{"inline":true,"label":"managed","permalink":"/docs/tags/managed"},{"inline":true,"label":"use-cases","permalink":"/docs/tags/use-cases"}],"version":"current","sidebarPosition":11,"frontMatter":{"sidebar_position":11,"title":"Managed configuration use cases","description":"Common use cases and examples for enterprise managed configuration.","tags":["podman-desktop","configuration","enterprise","managed","use-cases"],"keywords":["podman desktop","configuration","managed","enterprise","examples","use cases"]},"sidebar":"mySidebar","previous":{"title":"Configuring a managed user environment","permalink":"/docs/configuration/managed-configuration"},"next":{"title":"Troubleshooting managed configurations","permalink":"/docs/configuration/managed-configuration-troubleshooting"}}');
// EXTERNAL MODULE: ../node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(62540);
// EXTERNAL MODULE: ../node_modules/@mdx-js/react/lib/index.js
var lib = __webpack_require__(43023);
;// ./docs/configuration/managed-configuration-use-cases.mdx
