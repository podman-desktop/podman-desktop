"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[5960],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_kind_installing_extension_mdx_6b0_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-kind-installing-extension-mdx-6b0.json
const site_docs_kind_installing_extension_mdx_6b0_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"kind/installing-extension","title":"Installing the Kind extension","description":"Tutorial on how to install the Kind extension and use it","source":"@site/docs/kind/installing-extension.mdx","sourceDirName":"kind","slug":"/kind/installing-extension","permalink":"/docs/kind/installing-extension","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/kind/installing-extension.mdx","tags":[{"inline":true,"label":"podman","permalink":"/docs/tags/podman"},{"inline":true,"label":"kubernetes","permalink":"/docs/tags/kubernetes"},{"inline":true,"label":"kind","permalink":"/docs/tags/kind"}],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1,"title":"Installing the Kind extension","description":"Tutorial on how to install the Kind extension and use it","keywords":["podman desktop","podman","kind","kubernetes"],"tags":["podman","kubernetes","kind"]},"sidebar":"mySidebar","previous":{"title":"Kind","permalink":"/docs/kind/"},"next":{"title":"Installing the CLI","permalink":"/docs/kind/installing"}}');
...
;// ./docs/kind/installing-extension.mdx
