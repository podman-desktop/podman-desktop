(globalThis["webpackChunkdocs"] ||= []).push([[60777],{
...
/* harmony export */ });
/* harmony import */ var _chunk_JWPE2WC7_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(47776);
/* harmony import */ var _chunk_3NCLNEKW_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(29464);
/* harmony import */ var _chunk_WRU74C26_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(282);
/* harmony import */ var _chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52526);
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(81024);
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(25840);
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(16055);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(54681);
/* harmony import */ var _mermaid_js_parser__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(5165);
/* harmony import */ var cytoscape__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(60359);
/* harmony import */ var cytoscape_fcose__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(88955);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(47777);
...
var architectureGroupAlignmentKey = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((groupA, groupB) => {
...
var DEFAULT_ARCHITECTURE_CONFIG = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__/* .defaultConfig_default */ .UI.architecture;
var ArchitectureDB = class {
  ...
  getConfig() {
    return (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__/* .cleanAndMerge */ .$t)({
      ...DEFAULT_ARCHITECTURE_CONFIG,
      ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig */ .zj)().architecture
    });
  }
...
var architectureIcons = {
  ...
  icons: {
    ...
    unknown: _chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .unknownIcon */ .Gc,
    blank: {
      body: wrapIcon("")
    }
  }
  ...
  await Promise.all(
    cy.edges().map(async (edge) => {
      ...
      if (edge[0]._private.rscratch) {
        ...
        g.insert("path").attr("d", `M ${startX},${startY} L ${midX},${midY} L${endX},${endY} `).attr("class", "edge").attr("id", `${diagramId}-${(0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_4__/* .getEdgeId */ .rY)(source, target, { prefix: "L" })}`);
        if (sourceArrow) {
        ...
        if (label) {
          ...
          await (0,_chunk_WRU74C26_mjs__WEBPACK_IMPORTED_MODULE_2__/* .createText */ .G)(
            textElem,
            label,
            {
              useHtmlLabels: false,
            ...
            (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__/* .getConfig2 */ .D7)()
          );
    ...
    cy.nodes().map(async (node) => {
      ...
      if (data.type === "group") {
        ...
        if (data.icon) {
          ...
          bkgElem.html(
            `<g>${await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getIconSVG */ .WY)(data.icon, { height: groupIconSize, width: groupIconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
          );
          bkgElem.attr(
            "transform",
...
var drawServices = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(async function(db, elem, services, diagramId) {
  ...
  for (const service of services) {
    ...
    if (service.icon) {
      bkgElem.html(
        `<g>${await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getIconSVG */ .WY)(service.icon, { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
    } else if (service.iconText) {
      bkgElem.html(
        `<g>${await (0,_chunk_4I5QYGJK_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getIconSVG */ .WY)("blank", { height: iconSize, width: iconSize, fallbackPrefix: architectureIcons.prefix })}</g>`
      );
      const textElemContainer = bkgElem.append("g");
      const fo = textElemContainer.append("foreignObject").attr("width", iconSize).attr("height", iconSize);
      const divElem = fo.append("div").attr("class", "node-icon-text").attr("style", `height: ${iconSize}px;`).append("div").html((0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__/* .sanitizeText */ .jZ)(service.iconText, config));
...
function getAlignments(db, spatialMaps, groupAlignments, layoutHints = []) {
  const flattenAlignments = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)((alignmentMap, alignmentDir) => {
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_7__/* .__name */ .K)(async (text, id, _version, diagObj) => {
  ...
  positionNodes(db, cy);
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_5__/* .setupGraphViewbox */ .ot)(void 0, svg, db.getConfigField("padding"), db.getConfigField("useMaxWidth"));
}, "draw");
var renderer = { draw };
