"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[46420],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_configuration_managed_configuration_mdx_f68_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-configuration-managed-configuration-mdx-f68.json
const site_docs_configuration_managed_configuration_mdx_f68_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"configuration/managed-configuration","title":"Configuring a managed user environment","description":"Using managed configuration to enforce settings in enterprise environments.","source":"@site/docs/configuration/managed-configuration.mdx","sourceDirName":"configuration","slug":"/configuration/managed-configuration","permalink":"/docs/configuration/managed-configuration","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/configuration/managed-configuration.mdx","tags":[{"inline":true,"label":"podman-desktop","permalink":"/docs/tags/podman-desktop"},{"inline":true,"label":"configuration","permalink":"/docs/tags/configuration"},{"inline":true,"label":"enterprise","permalink":"/docs/tags/enterprise"},{"inline":true,"label":"managed","permalink":"/docs/tags/managed"}],"version":"current","sidebarPosition":10,"frontMatter":{"sidebar_position":10,"title":"Configuring a managed user environment","description":"Using managed configuration to enforce settings in enterprise environments.","tags":["podman-desktop","configuration","enterprise","managed"],"keywords":["podman desktop","configuration","managed","enterprise","locked","admin","policy"]},"sidebar":"mySidebar","previous":{"title":"Settings reference","permalink":"/docs/configuration/settings-reference"},"next":{"title":"Managed configuration use cases","permalink":"/docs/configuration/managed-configuration-use-cases"}}');
...
;// ./docs/configuration/managed-configuration.mdx
