"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[20076],{
...
function applyMarkerOffsets(points, edge) {
  ...
  const startOff = edge.arrowTypeStart && _chunk_R7TYR2AO_mjs__WEBPACK_IMPORTED_MODULE_2__/* .markerOffsets */ .hq[edge.arrowTypeStart];
  if (startOff) {
    const a = points[0];
    const b = points[1];
  ...
  const endOff = edge.arrowTypeEnd && _chunk_R7TYR2AO_mjs__WEBPACK_IMPORTED_MODULE_2__/* .markerOffsets */ .hq[edge.arrowTypeEnd];
  if (endOff) {
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)(applySwimlaneLineJumps, "applySwimlaneLineJumps");
...
(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_11__/* .__name */ .K)(prepareSwimlaneLayout, "prepareSwimlaneLayout");
