...
`),n=(d=((c=t.find(s=>s.startsWith("#EXT-X-PLAYLIST-TYPE")))!=null?c:"").split(":")[1])==null?void 0:d.trim(),o=dist_Q(n),a=Z(n),i;if(o===dist_.LIVE){let s=t.find(l=>l.startsWith("#EXT-X-PART-INF"));if(!!s)i=+s.split(":")[1].split("=")[1]*2;else{let l=t.find(R=>R.startsWith("#EXT-X-TARGETDURATION")),T=(u=l==null?void 0:l.split(":"))==null?void 0:u[1];i=+(T!=null?T:6)*3}}return{streamType:o,targetLiveWindow:a,liveEdgeStartOffset:i}},dist_Mt=async(e,t)=>{if(t===dist_A.MP4)return{streamType:dist_.ON_DEMAND,targetLiveWindow:Number.NaN,liveEdgeStartOffset:void 0,sessionData:void 0};if(t===dist_A.M3U8){let r=await fetch(e);if(!r.ok)return Promise.reject(r);let n=await r.text(),o=await dist_Tt(n);return{...dist_yt(n),...dist_gt(o)}}return console.error(`Media type ${t} is an unrecognized or unsupported type for src ${e}.`),{streamType:void 0,targetLiveWindow:void 0,liveEdgeStartOffset:void 0,sessionData:void 0}},dist_xt=async(e,t,r=dist_U({src:e}))=>{var d,u,s,p;let{streamType:n,targetLiveWindow:o,liveEdgeStartOffset:a,sessionData:i}=await dist_Mt(e,r),c=i==null?void 0:i["com.apple.hls.chapters"];(c!=null&&c.URI||c!=null&&c.VALUE.toLocaleLowerCase().startsWith("http"))&&dist_de((d=c.URI)!=null?d:c.VALUE,t),((u=dist_P.get(t))!=null?u:{}).liveEdgeStartOffset=a,((s=dist_P.get(t))!=null?s:{}).targetLiveWindow=o,t.dispatchEvent(new CustomEvent("targetlivewindowchange",{composed:!0,bubbles:!0})),((p=dist_P.get(t))!=null?p:{}).streamType=n,t.dispatchEvent(new CustomEvent("streamtypechange",{composed:!0,bubbles:!0}))},dist_de=async(e,t)=>{var r,n;try{let o=await fetch(e);if(!o.ok)throw new Error(`Failed to fetch Mux metadata: ${o.status} ${o.statusText}`);let a=await o.json(),i={};if(!((r=a==null?void 0:a[0])!=null&&r.metadata))return;for(let d of a[0].metadata)d.key&&d.value&&(i[d.key]=d.value);((n=dist_P.get(t))!=null?n:{}).metadata=i;let c=new CustomEvent("muxmetadata");t.dispatchEvent(c)}catch(o){console.error(o)}},dist_Rt=e=>{var i;let t=e.type,r=dist_Q(t),n=Z(t),o,a=!!((i=e.partList)!=null&&i.length);return r===dist_.LIVE&&(o=a?e.partTarget*2:e.targetduration*3),{streamType:r,targetLiveWindow:n,liveEdgeStartOffset:o,lowLatency:a}},dist_bt=(e,t,r)=>{var c,d,u,s,p,l,T,m;let{streamType:n,targetLiveWindow:o,liveEdgeStartOffset:a,lowLatency:i}=dist_Rt(e);if(n===dist_.LIVE){i?(r.config.backBufferLength=(c=r.userConfig.backBufferLength)!=null?c:4,r.config.maxFragLookUpTolerance=(d=r.userConfig.maxFragLookUpTolerance)!=null?d:.001,r.config.abrBandWidthUpFactor=(u=r.userConfig.abrBandWidthUpFactor)!=null?u:r.config.abrBandWidthFactor):r.config.backBufferLength=(s=r.userConfig.backBufferLength)!=null?s:8;let R=Object.freeze({get length(){return t.seekable.length},start(M){return t.seekable.start(M)},end(M){var h;return M>this.length||M<0||Number.isFinite(t.duration)?t.seekable.end(M):(h=r.liveSyncPosition)!=null?h:t.seekable.end(M)}});((p=dist_P.get(t))!=null?p:{}).seekable=R}((l=dist_P.get(t))!=null?l:{}).liveEdgeStartOffset=a,((T=dist_P.get(t))!=null?T:{}).targetLiveWindow=o,t.dispatchEvent(new CustomEvent("targetlivewindowchange",{composed:!0,bubbles:!0})),((m=dist_P.get(t))!=null?m:{}).streamType=n,t.dispatchEvent(new CustomEvent("streamtypechange",{composed:!0,bubbles:!0}))},dist_Oe,dist_Ue,dist_Dt=(dist_Ue=(dist_Oe=globalThis==null?void 0:globalThis.navigator)==null?void 0:dist_Oe.userAgent)!=null?dist_Ue:"",dist_He,Ve,dist_Ke,dist_Ct=(dist_Ke=(Ve=(dist_He=globalThis==null?void 0:globalThis.navigator)==null?void 0:dist_He.userAgentData)==null?void 0:Ve.platform)!=null?dist_Ke:"",dist_vt=dist_Dt.toLowerCase().includes("android")||["x11","android"].some(e=>dist_Ct.toLowerCase().includes(e)),dist_P=new WeakMap,I="mux.com",We,dist_Ye,dist_Fe=(dist_Ye=(We=g).isSupported)==null?void 0:dist_Ye.call(We),dist_Pt=dist_vt,dist_Wr=()=>Cd.utils.now(),dist_t=Cd.utils.generateUUID,Yr=({playbackId:e,customDomain:t=I,maxResolution:r,minResolution:n,renditionOrder:o,programStartTime:a,programEndTime:i,assetStartTime:c,assetEndTime:d,playbackToken:u,tokens:{playback:s=u}={},extraSourceParams:p={}}={})=>{if(!e)return;let[l,T=""]=dist_F(e),m=new URL(`https://stream.${t}/${l}.m3u8${T}`);return s||m.searchParams.has("token")?(m.searchParams.forEach((R,M)=>{M!="token"&&m.searchParams.delete(M)}),s&&m.searchParams.set("token",s)):(r&&m.searchParams.set("max_resolution",r),n&&(m.searchParams.set("min_resolution",n),r&&+r.slice(0,-1)<+n.slice(0,-1)&&console.error("minResolution must be <= maxResolution","minResolution",n,"maxResolution",r)),o&&m.searchParams.set("rendition_order",o),a&&m.searchParams.set("program_start_time",`${a}`),i&&m.searchParams.set("program_end_time",`${i}`),c&&m.searchParams.set("asset_start_time",`${c}`),d&&m.searchParams.set("asset_end_time",`${d}`),Object.entries(p).forEach(([R,M])=>{M!=null&&m.searchParams.set(R,M)})),m.toString()},dist_G=e=>{if(!e)return;let[t]=e.split("?");return t||void 0},dist_$e=e=>{if(!e||!e.startsWith("https://stream."))return;let[t]=new URL(e).pathname.slice(1).split(/\.m3u8|\//);return t||void 0},dist_kt=e=>{var t,r,n;return(t=e==null?void 0:e.metadata)!=null&&t.video_id?e.metadata.video_id:dist_Xe(e)&&(n=(r=dist_G(e.playbackId))!=null?r:dist_$e(e.src))!=null?n:e.src},ht=e=>{var t;return(t=dist_P.get(e))==null?void 0:t.error},dist_Fr=e=>{var t;return(t=dist_P.get(e))==null?void 0:t.metadata},we=e=>{var t,r;return(r=(t=dist_P.get(e))==null?void 0:t.streamType)!=null?r:dist_.UNKNOWN},$r=e=>{var t,r;return(r=(t=dist_P.get(e))==null?void 0:t.targetLiveWindow)!=null?r:Number.NaN},Be=e=>{var t,r;return(r=(t=dist_P.get(e))==null?void 0:t.seekable)!=null?r:e.seekable},dist_Br=e=>{var n;let t=(n=dist_P.get(e))==null?void 0:n.liveEdgeStartOffset;if(typeof t!="number")return Number.NaN;let r=Be(e);return r.length?r.end(r.length-1)-t:Number.NaN},dist_le=.034,dist_Lt=(e,t,r=dist_le)=>Math.abs(e-t)<=r,je=(e,t,r=dist_le)=>e>t||dist_Lt(e,t,r),dist_Nt=(e,t=dist_le)=>e.paused&&je(e.currentTime,e.duration,t),dist_Je=(e,t)=>{var u,s,p;if(!t||!e.buffered.length)return;if(e.readyState>2)return!1;let r=t.currentLevel>=0?(s=(u=t.levels)==null?void 0:u[t.currentLevel])==null?void 0:s.details:(p=t.levels.find(l=>!!l.details))==null?void 0:p.details;if(!r||r.live)return;let{fragments:n}=r;if(!(n!=null&&n.length))return;if(e.currentTime<e.duration-(r.targetduration+.5))return!1;let o=n[n.length-1];if(e.currentTime<=o.start)return!1;let a=o.start+o.duration/2,i=e.buffered.start(e.buffered.length-1),c=e.buffered.end(e.buffered.length-1);return a>i&&a<c},dist_At=(e,t)=>e.ended||e.loop?e.ended:t&&dist_Je(e,t)?!0:dist_Nt(e),dist_jr=(e,t,r)=>{dist_It(t,r,e);let{metadata:n={}}=e,{view_session_id:o=dist_t()}=n,a=dist_kt(e);n.view_session_id=o,n.video_id=a,e.metadata=n;let i=s=>{var p;(p=t.mux)==null||p.emit("hb",{view_drm_type:s})};e.drmTypeCb=i,dist_P.set(t,{retryCount:0});let c=dist_St(e,t),d=Re(e,t,c);e!=null&&e.muxDataKeepSession&&(t!=null&&t.mux)&&!t.mux.deleted?c&&t.mux.addHLSJS({hlsjs:c,Hls:c?g:void 0}):dist_Kt(e,t,c),dist_Wt(e,t,c),dist_ke(t),dist_Ae(t);let u=xe(e,t,c);return{engine:c,setAutoplay:u,setPreload:d}},dist_It=(e,t,r)=>{let n=t==null?void 0:t.engine;e!=null&&e.mux&&!e.mux.deleted&&(r!=null&&r.muxDataKeepSession?n&&e.mux.removeHLSJS():(e.mux.destroy(),delete e.mux)),n&&(n.detachMedia(),n.destroy()),e&&(e.hasAttribute("src")&&(e.removeAttribute("src"),e.load()),e.removeEventListener("error",dist_Qe),e.removeEventListener("error",dist_ce),e.removeEventListener("durationchange",dist_ze),dist_P.delete(e),e.dispatchEvent(new Event("teardown")))};function qe(e,t){var u;let r=dist_U(e);if(!(r===dist_A.M3U8))return!0;let o=!r||((u=t.canPlayType(r))!=null?u:!0),{preferPlayback:a}=e,i=a===dist_X.MSE,c=a===dist_X.NATIVE;return o&&(c||!(dist_Fe&&(i||dist_Pt)))}var dist_St=(e,t)=>{let{debug:r,streamType:n,startTime:o=-1,metadata:a,preferCmcd:i,_hlsConfig:c={}}=e,u=dist_U(e)===dist_A.M3U8,s=qe(e,t);if(u&&!s&&dist_Fe){let p={backBufferLength:30,renderTextTracksNatively:!1,liveDurationInfinity:!0,capLevelToPlayerSize:!0,capLevelOnFPSDrop:!0},l=dist_wt(n),T=dist_Ot(e),m=[S.QUERY,S.HEADER].includes(i)?{useHeaders:i===S.HEADER,sessionId:a==null?void 0:a.view_session_id,contentId:a==null?void 0:a.video_id}:void 0,R=new g({debug:r,startPosition:o,cmcd:m,xhrSetup:(M,h)=>{var y,k;if(i&&i!==S.QUERY)return;let E=new URL(h);if(!E.searchParams.has("CMCD"))return;let D=((k=(y=E.searchParams.get("CMCD"))==null?void 0:y.split(","))!=null?k:[]).filter(pe=>pe.startsWith("sid")||pe.startsWith("cid")).join(",");E.searchParams.set("CMCD",D),M.open("GET",E)},capLevelController:dist_Se,...p,...l,...T,...c});return R.on(g.Events.MANIFEST_PARSED,async function(M,h){var D,y;let E=(D=h.sessionData)==null?void 0:D["com.apple.hls.chapters"];(E!=null&&E.URI||E!=null&&E.VALUE.toLocaleLowerCase().startsWith("http"))&&dist_de((y=E==null?void 0:E.URI)!=null?y:E==null?void 0:E.VALUE,t)}),R}},dist_wt=e=>e===dist_.LIVE?{backBufferLength:8}:{},dist_Ot=e=>{let{tokens:{drm:t}={},playbackId:r,drmTypeCb:n}=e,o=dist_G(r);return!t||!o?{}:{emeEnabled:!0,drmSystems:{"com.apple.fps":{licenseUrl:q(e,"fairplay"),serverCertificateUrl:dist_Ge(e,"fairplay")},"com.widevine.alpha":{licenseUrl:q(e,"widevine")},"com.microsoft.playready":{licenseUrl:q(e,"playready")}},requestMediaKeySystemAccessFunc:(a,i)=>(a==="com.widevine.alpha"&&(i=[...i.map(c=>{var u;let d=(u=c.videoCapabilities)==null?void 0:u.map(s=>({...s,robustness:"HW_SECURE_ALL"}));return{...c,videoCapabilities:d}}),...i]),navigator.requestMediaKeySystemAccess(a,i).then(c=>{let d=dist_ft(a);return n==null||n(d),c}))}},dist_Ut=async e=>{let t=await fetch(e);return t.status!==200?Promise.reject(t):await t.arrayBuffer()},dist_Ht=async(e,t)=>{let r=await fetch(t,{method:"POST",headers:{"Content-type":"application/octet-stream"},body:e});if(r.status!==200)return Promise.reject(r);let n=await r.arrayBuffer();return new Uint8Array(n)},dist_Vt=(e,t)=>{v(t,"encrypted",async n=>{try{let o=n.initDataType;if(o!=="skd"){console.error(`Received unexpected initialization data type "${o}"`);return}if(!t.mediaKeys){let u=await navigator.requestMediaKeySystemAccess("com.apple.fps",[{initDataTypes:[o],videoCapabilities:[{contentType:"application/vnd.apple.mpegurl",robustness:""}],distinctiveIdentifier:"not-allowed",persistentState:"not-allowed",sessionTypes:["temporary"]}]).then(p=>{var l;return(l=e.drmTypeCb)==null||l.call(e,dist_J.FAIRPLAY),p}).catch(()=>{let p=x("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser."),l=new f(p,f.MEDIA_ERR_ENCRYPTED,!0);l.errorCategory=dist_C.DRM,l.muxCode=dist_b.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM,dist_N(t,l)});if(!u)return;let s=await u.createMediaKeys();try{let p=await dist_Ut(dist_Ge(e,"fairplay")).catch(l=>{if(l instanceof Response){let T=dist_H(l,dist_C.DRM,e);return console.error("mediaError",T==null?void 0:T.message,T==null?void 0:T.context),T?Promise.reject(T):Promise.reject(new Error("Unexpected error in app cert request"))}return Promise.reject(l)});await s.setServerCertificate(p).catch(()=>{let l=x("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate."),T=new f(l,f.MEDIA_ERR_ENCRYPTED,!0);return T.errorCategory=dist_C.DRM,T.muxCode=dist_b.ENCRYPTED_UPDATE_SERVER_CERT_FAILED,Promise.reject(T)})}catch(p){dist_N(t,p);return}await t.setMediaKeys(s)}let a=n.initData;if(a==null){console.error(`Could not start encrypted playback due to missing initData in ${n.type} event`);return}let i=t.mediaKeys.createSession();i.addEventListener("keystatuseschange",()=>{i.keyStatuses.forEach(u=>{let s;if(u==="internal-error"){let p=x("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");s=new f(p,f.MEDIA_ERR_ENCRYPTED,!0),s.errorCategory=dist_C.DRM,s.muxCode=dist_b.ENCRYPTED_CDM_ERROR}else if(u==="output-restricted"||u==="output-downscaled"){let p=x("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");s=new f(p,f.MEDIA_ERR_ENCRYPTED,!1),s.errorCategory=dist_C.DRM,s.muxCode=dist_b.ENCRYPTED_OUTPUT_RESTRICTED}s&&dist_N(t,s)})});let c=await Promise.all([i.generateRequest(o,a).catch(()=>{let u=x("Failed to generate a DRM license request. This may be an issue with the player or your protected content."),s=new f(u,f.MEDIA_ERR_ENCRYPTED,!0);s.errorCategory=dist_C.DRM,s.muxCode=dist_b.ENCRYPTED_GENERATE_REQUEST_FAILED,dist_N(t,s)}),new Promise(u=>{i.addEventListener("message",s=>{u(s.message)},{once:!0})})]).then(([,u])=>u),d=await dist_Ht(c,q(e,"fairplay")).catch(u=>{if(u instanceof Response){let s=dist_H(u,dist_C.DRM,e);return console.error("mediaError",s==null?void 0:s.message,s==null?void 0:s.context),s?Promise.reject(s):Promise.reject(new Error("Unexpected error in license key request"))}return Promise.reject(u)});await i.update(d).catch(()=>{let u=x("Failed to update DRM license. This may be an issue with the player or your protected content."),s=new f(u,f.MEDIA_ERR_ENCRYPTED,!0);return s.errorCategory=dist_C.DRM,s.muxCode=dist_b.ENCRYPTED_UPDATE_LICENSE_FAILED,Promise.reject(s)})}catch(o){dist_N(t,o);return}})},q=({playbackId:e,tokens:{drm:t}={},customDomain:r=I},n)=>{let o=dist_G(e);return`https://license.${r.toLocaleLowerCase().endsWith(I)?r:I}/license/${n}/${o}?token=${t}`},dist_Ge=({playbackId:e,tokens:{drm:t}={},customDomain:r=I},n)=>{let o=dist_G(e);return`https://license.${r.toLocaleLowerCase().endsWith(I)?r:I}/appcert/${n}/${o}?token=${t}`},dist_Xe=({playbackId:e,src:t,customDomain:r})=>{if(e)return!0;if(typeof t!="string")return!1;let n=window==null?void 0:window.location.href,o=new URL(t,n).hostname.toLocaleLowerCase();return o.includes(I)||!!r&&o.includes(r.toLocaleLowerCase())},dist_Kt=(e,t,r)=>{var d;let{envKey:n,disableTracking:o,muxDataSDK:a=Cd,muxDataSDKOptions:i={}}=e,c=dist_Xe(e);if(!o&&(n||c)){let{playerInitTime:u,playerSoftwareName:s,playerSoftwareVersion:p,beaconCollectionDomain:l,debug:T,disableCookies:m}=e,R={...e.metadata,video_title:((d=e==null?void 0:e.metadata)==null?void 0:d.video_title)||void 0},M=h=>typeof h.player_error_code=="string"?!1:typeof e.errorTranslator=="function"?e.errorTranslator(h):h;a.monitor(t,{debug:T,beaconCollectionDomain:l,hlsjs:r,Hls:r?g:void 0,automaticErrorTracking:!1,errorTranslator:M,disableCookies:m,...i,data:{...n?{env_key:n}:{},player_software_name:s,player_software:s,player_software_version:p,player_init_time:u,...R}})}},dist_Wt=(e,t,r)=>{var s,p;let n=qe(e,t),{src:o,customDomain:a=I}=e,i=()=>{t.ended||e.disablePseudoEnded||!dist_At(t,r)||(dist_Je(t,r)?t.currentTime=t.buffered.end(t.buffered.length-1):t.dispatchEvent(new Event("ended")))},c,d,u=()=>{let l=Be(t),T,m;l.length>0&&(T=l.start(0),m=l.end(0)),(d!==m||c!==T)&&t.dispatchEvent(new CustomEvent("seekablechange",{composed:!0})),c=T,d=m};if(v(t,"durationchange",u),t&&n){let l=dist_U(e);if(typeof o=="string"){if(o.endsWith(".mp4")&&o.includes(a)){let R=dist_$e(o),M=new URL(`https://stream.${a}/${R}/metadata.json`);dist_de(M.toString(),t)}let T=()=>{if(we(t)!==dist_.LIVE||Number.isFinite(t.duration))return;let R=setInterval(u,1e3);t.addEventListener("teardown",()=>{clearInterval(R)},{once:!0}),v(t,"durationchange",()=>{Number.isFinite(t.duration)&&clearInterval(R)})},m=async()=>dist_xt(o,t,l).then(T).catch(R=>{if(R instanceof Response){let M=dist_H(R,dist_C.VIDEO,e);if(M){dist_N(t,M);return}}else R instanceof Error});if(t.preload==="none"){let R=()=>{m(),t.removeEventListener("loadedmetadata",M)},M=()=>{m(),t.removeEventListener("play",R)};v(t,"play",R,{once:!0}),v(t,"loadedmetadata",M,{once:!0})}else m();(s=e.tokens)!=null&&s.drm?dist_Vt(e,t):v(t,"encrypted",()=>{let R=x("Attempting to play DRM-protected content without providing a DRM token."),M=new f(R,f.MEDIA_ERR_ENCRYPTED,!0);M.errorCategory=dist_C.DRM,M.muxCode=dist_b.ENCRYPTED_MISSING_TOKEN,dist_N(t,M)},{once:!0}),t.setAttribute("src",o),e.startTime&&(((p=dist_P.get(t))!=null?p:{}).startTime=e.startTime,t.addEventListener("durationchange",dist_ze,{once:!0}))}else t.removeAttribute("src");t.addEventListener("error",dist_Qe),t.addEventListener("error",dist_ce),t.addEventListener("emptied",()=>{t.querySelectorAll("track[data-removeondestroy]").forEach(m=>{m.remove()})},{once:!0}),v(t,"pause",i),v(t,"seeked",i),v(t,"play",()=>{t.ended||je(t.currentTime,t.duration)&&(t.currentTime=t.seekable.length?t.seekable.start(0):0)})}else r&&o?(r.once(g.Events.LEVEL_LOADED,(l,T)=>{dist_bt(T.details,t,r),u(),we(t)===dist_.LIVE&&!Number.isFinite(t.duration)&&(r.on(g.Events.LEVEL_UPDATED,u),v(t,"durationchange",()=>{Number.isFinite(t.duration)&&r.off(g.Events.LEVELS_UPDATED,u)}))}),r.on(g.Events.ERROR,(l,T)=>{var R,M;let m=dist_Yt(T,e);if(m.muxCode===dist_b.NETWORK_NOT_READY){let E=(R=dist_P.get(t))!=null?R:{},D=(M=E.retryCount)!=null?M:0;if(D<6){let y=D===0?5e3:6e4,k=new f(`Retrying in ${y/1e3} seconds...`,m.code,m.fatal);Object.assign(k,m),dist_N(t,k),setTimeout(()=>{E.retryCount=D+1,T.details==="manifestLoadError"&&T.url&&r.loadSource(T.url)},y);return}else{E.retryCount=0;let y=new f('Try again later or <a href="#" onclick="window.location.reload(); return false;" style="color: #4a90e2;">click here to retry</a>',m.code,m.fatal);Object.assign(y,m),dist_N(t,y);return}}dist_N(t,m)}),r.on(g.Events.MANIFEST_LOADED,()=>{let l=dist_P.get(t);l&&l.error&&(l.error=null,l.retryCount=0,t.dispatchEvent(new Event("emptied")),t.dispatchEvent(new Event("loadstart")))}),t.addEventListener("error",dist_ce),v(t,"waiting",i),dist_be(e,r),dist_De(t,r),r.attachMedia(t)):console.error("It looks like the video you're trying to play will not work on this system! If possible, try upgrading to the newest versions of your browser or software.")};function dist_ze(e){var n;let t=e.target,r=(n=dist_P.get(t))==null?void 0:n.startTime;if(r&&dist_fe(t.seekable,t.duration,r)){let o=t.preload==="auto";o&&(t.preload="none"),t.currentTime=r,o&&(t.preload="auto")}}async function dist_Qe(e){if(!e.isTrusted)return;e.stopImmediatePropagation();let t=e.target;if(!(t!=null&&t.error))return;let{message:r,code:n}=t.error,o=new f(r,n);if(t.src&&n===f.MEDIA_ERR_SRC_NOT_SUPPORTED&&t.readyState===HTMLMediaElement.HAVE_NOTHING){setTimeout(()=>{var i;let a=(i=ht(t))!=null?i:t.error;(a==null?void 0:a.code)===f.MEDIA_ERR_SRC_NOT_SUPPORTED&&dist_N(t,o)},500);return}if(t.src&&(n!==f.MEDIA_ERR_DECODE||n!==void 0))try{let{status:a}=await fetch(t.src);o.data={response:{code:a}}}catch{}dist_N(t,o)}function dist_N(e,t){var r;t.fatal&&(((r=dist_P.get(e))!=null?r:{}).error=t,e.dispatchEvent(new CustomEvent("error",{detail:t})))}function dist_ce(e){var n,o;if(!(e instanceof CustomEvent)||!(e.detail instanceof f))return;let t=e.target,r=e.detail;!r||!r.fatal||(((n=dist_P.get(t))!=null?n:{}).error=r,(o=t.mux)==null||o.emit("error",{player_error_code:r.code,player_error_message:r.message,player_error_context:r.context}))}var dist_Yt=(e,t)=>{var c,d,u;console.error("getErrorFromHlsErrorData()",e);let r={[g.ErrorTypes.NETWORK_ERROR]:f.MEDIA_ERR_NETWORK,[g.ErrorTypes.MEDIA_ERROR]:f.MEDIA_ERR_DECODE,[g.ErrorTypes.KEY_SYSTEM_ERROR]:f.MEDIA_ERR_ENCRYPTED},n=s=>[g.ErrorDetails.KEY_SYSTEM_LICENSE_REQUEST_FAILED,g.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_REQUEST_FAILED].includes(s.details)?f.MEDIA_ERR_NETWORK:r[s.type],o=s=>{if(s.type===g.ErrorTypes.KEY_SYSTEM_ERROR)return dist_C.DRM;if(s.type===g.ErrorTypes.NETWORK_ERROR)return dist_C.VIDEO},a,i=n(e);if(i===f.MEDIA_ERR_NETWORK&&e.response){let s=(c=o(e))!=null?c:dist_C.VIDEO;a=(d=dist_H(e.response,s,t,e.fatal))!=null?d:new f("",i,e.fatal)}else if(i===f.MEDIA_ERR_ENCRYPTED)if(e.details===g.ErrorDetails.KEY_SYSTEM_NO_CONFIGURED_LICENSE){let s=x("Attempting to play DRM-protected content without providing a DRM token.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,e.fatal),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_MISSING_TOKEN}else if(e.details===g.ErrorDetails.KEY_SYSTEM_NO_ACCESS){let s=x("Cannot play DRM-protected content with current security configuration on this browser. Try playing in another browser.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,e.fatal),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_UNSUPPORTED_KEY_SYSTEM}else if(e.details===g.ErrorDetails.KEY_SYSTEM_NO_SESSION){let s=x("Failed to generate a DRM license request. This may be an issue with the player or your protected content.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,!0),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_GENERATE_REQUEST_FAILED}else if(e.details===g.ErrorDetails.KEY_SYSTEM_SESSION_UPDATE_FAILED){let s=x("Failed to update DRM license. This may be an issue with the player or your protected content.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,e.fatal),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_UPDATE_LICENSE_FAILED}else if(e.details===g.ErrorDetails.KEY_SYSTEM_SERVER_CERTIFICATE_UPDATE_FAILED){let s=x("Your server certificate failed when attempting to set it. This may be an issue with a no longer valid certificate.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,e.fatal),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_UPDATE_SERVER_CERT_FAILED}else if(e.details===g.ErrorDetails.KEY_SYSTEM_STATUS_INTERNAL_ERROR){let s=x("The DRM Content Decryption Module system had an internal failure. Try reloading the page, upading your browser, or playing in another browser.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,e.fatal),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_CDM_ERROR}else if(e.details===g.ErrorDetails.KEY_SYSTEM_STATUS_OUTPUT_RESTRICTED){let s=x("DRM playback is being attempted in an environment that is not sufficiently secure. User may see black screen.");a=new f(s,f.MEDIA_ERR_ENCRYPTED,!1),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_OUTPUT_RESTRICTED}else a=new f(e.error.message,f.MEDIA_ERR_ENCRYPTED,e.fatal),a.errorCategory=dist_C.DRM,a.muxCode=dist_b.ENCRYPTED_ERROR;else a=new f("",i,e.fatal);return a.context||(a.context=`${e.url?`url: ${e.url}
