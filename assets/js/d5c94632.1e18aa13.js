"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[48635],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  metadata: () => (/* reexport */ site_docs_minikube_installing_extension_mdx_d5c_namespaceObject),
  toc: () => (/* binding */ toc)
});

;// ./.docusaurus/docusaurus-plugin-content-docs/default/site-docs-minikube-installing-extension-mdx-d5c.json
const site_docs_minikube_installing_extension_mdx_d5c_namespaceObject = /*#__PURE__*/JSON.parse('{"id":"minikube/installing-extension","title":"Installing the Minikube extension","description":"Tutorial on how to install the Minikube extension and use it","source":"@site/docs/minikube/installing-extension.mdx","sourceDirName":"minikube","slug":"/minikube/installing-extension","permalink":"/docs/minikube/installing-extension","draft":false,"unlisted":false,"editUrl":"https://github.com/podman-desktop/podman-desktop/tree/main/website/docs/minikube/installing-extension.mdx","tags":[{"inline":true,"label":"podman","permalink":"/docs/tags/podman"},{"inline":true,"label":"kubernetes","permalink":"/docs/tags/kubernetes"},{"inline":true,"label":"minikube","permalink":"/docs/tags/minikube"}],"version":"current","sidebarPosition":1,"frontMatter":{"sidebar_position":1,"title":"Installing the Minikube extension","description":"Tutorial on how to install the Minikube extension and use it","keywords":["podman desktop","podman","minikube","kubernetes"],"tags":["podman","kubernetes","minikube"]},"sidebar":"mySidebar","previous":{"title":"Minikube","permalink":"/docs/minikube/"},"next":{"title":"Installing the CLI","permalink":"/docs/minikube/installing"}}');
...
;// ./docs/minikube/installing-extension.mdx
