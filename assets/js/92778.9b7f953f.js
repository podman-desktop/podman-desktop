"use strict";
(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[92778],{
...
/* harmony import */ var _chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33785);
...
var TextDimensionCalculatorWithFont = class {
  ...
  getMaxDimension(texts, fontSize) {
    ...
    for (const t of texts) {
      const bbox = (0,_chunk_O5CBEL6O_mjs__WEBPACK_IMPORTED_MODULE_1__/* .computeDimensionOfText */ .W6)(elem, 1, t);
...
function getChartDefaultThemeConfig() {
  ...
  return (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(defaultThemeVariables.xyChart, config.themeVariables.xyChart);
}
(0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)(getChartDefaultThemeConfig, "getChartDefaultThemeConfig");
function getChartDefaultConfig() {
  const config = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_5ZQYHXKU_mjs__WEBPACK_IMPORTED_MODULE_2__/* .cleanAndMerge */ .$t)(
    _chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .defaultConfig_default */ .UI.xyChart,
    config.xyChart
  );
}
...
function textSanitizer(text) {
  const config = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getConfig */ .zj)();
  return (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .sanitizeText */ .jZ)(text.trim(), config);
}
...
function getDrawableElem() {
  ...
  xyChartData.title = (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .getDiagramTitle */ .ab)();
...
var draw = /* @__PURE__ */ (0,_chunk_AGHRB4JF_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K2)((txt, id, _version, diagObj) => {
  ...
  (0,_chunk_CSCIHK7Q_mjs__WEBPACK_IMPORTED_MODULE_3__/* .configureSvgSize */ .a$)(svg, chartConfig.height, chartConfig.width, true);
