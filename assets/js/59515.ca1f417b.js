(globalThis["webpackChunkdocs"] = globalThis["webpackChunkdocs"] || []).push([[59515],{
...
var parse_numeric_range = __webpack_require__(19934);
...
// extracted by mini-css-extract-plugin
/* harmony default export */ const CopyButton_styles_module = ({"copyButtonCopied":"copyButtonCopied_WAFi","copyButtonIcons":"copyButtonIcons_Fy7c","copyButtonIcon":"copyButtonIcon_r1h_","copyButtonSuccessIcon":"copyButtonSuccessIcon_BIMv"});
...
const{default:copy}=await __webpack_require__.e(/* import() */ 23754).then(__webpack_require__.bind(__webpack_require__, 23754));return copy(text);}function useCopyButton(){const{metadata:{code}}=useCodeBlockContext();const[isCopied,setIsCopied]=(0,react.useState)(false);const copyTimeout=(0,react.useRef)(undefined);const copyCode=(0,react.useCallback)(()=>{copyToClipboard(code).then(()=>{setIsCopied(true);copyTimeout.current=window.setTimeout(()=>{setIsCopied(false);},1000);});// Errors are intentionally not caught so they remain unhandled and can
...
var Heading = __webpack_require__(3450);
