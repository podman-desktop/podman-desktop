"use strict";
(globalThis["webpackChunkdocs"] ||= []).push([[91079],{
...
/* harmony import */ var _chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(81024);
/* harmony import */ var _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(25840);
/* harmony import */ var _chunk_X3CZISLH_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(16055);
/* harmony import */ var _chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(54681);
...
var clear2 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(function() {
  reset();
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .clear */ .IU)();
}, "clear");
function reset() {
  store = {};
}
;(0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(reset, "reset");
var DEFAULT_EVENTMODELING_CONFIG = _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .defaultConfig_default */ .UI.eventmodeling;
var getConfig3 = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(() => {
  const config = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__/* .cleanAndMerge */ .$t)({
    ...DEFAULT_EVENTMODELING_CONFIG,
    ...(0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)().eventmodeling
  });
  return config;
}, "getConfig");
var store = {};
...
function calculateEntityVisualProps(frame) {
  const { themeVariables } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)();
  switch (frame.modelEntityType) {
    case "ui":
      return {
...
function calculateTextProps(frame, dataEntities, diagramProps2) {
  const config = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig */ .zj)();
  const name = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeText */ .jZ)(extractName(frame.entityIdentifier) ?? "", config);
  let toHtml;
  ...
  const wrappedName = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__/* .wrapLabel */ .bH)(name, diagramProps2.textMaxWidth, wrapLabelConfig);
  ...
  if (frame.dataInlineValue) {
    ...
    toHtml = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .sanitizeText */ .jZ)(toHtml, config);
    toHtml = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__/* .wrapLabel */ .bH)(toHtml, diagramProps2.textMaxWidth, wrapLabelConfig);
  ...
  const dimensions = (0,_chunk_NSK5VX7P_mjs__WEBPACK_IMPORTED_MODULE_1__/* .calculateTextDimensions */ .PX)(content, textDimensionConfig);
...
var db = {
  ...
  getOptions,
  clear: clear2,
  setAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setAccTitle */ .SV,
  getAccTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getAccTitle */ .iN,
  getAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getAccDescription */ .m7,
  setAccDescription: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setAccDescription */ .EI,
  setDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setDiagramTitle */ .ke,
  getDiagramTitle: _chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getDiagramTitle */ .ab,
  setAst,
  getDiagramProps,
  getState
};
...
;
var DEFAULT_CONFIG = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)();
...
var draw = /* @__PURE__ */ (0,_chunk_Y2CYZVJY_mjs__WEBPACK_IMPORTED_MODULE_4__/* .__name */ .K)(function(txt, id, ver, diagObj) {
  ...
  const { themeVariables, eventmodeling: config } = (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .getConfig2 */ .D7)();
  ...
  (0,_chunk_I66GZJ75_mjs__WEBPACK_IMPORTED_MODULE_2__/* .setupGraphViewbox2 */ .mj)(void 0, diagram2, config?.padding ?? 30, config?.useMaxWidth);
}, "draw");
