import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,Dt as n,N as r,Nt as i,Sn as a,Ut as o,at as s,gt as c,hn as l,jt as u,m as d,nn as f,q as p,rn as m,rt as h,s as g,st as _,un as v,yn as y}from"./iframe-BMm0UYlC.js";import{a as b,i as x,n as S,r as ee,t as te}from"./create-runtime-stories-KoyR0bXJ.js";import{L as ne,P as C,f as re,g as w,t as T}from"./Icon-CxHVWYL0.js";import{r as ie}from"./Button-DOM_e4W9.js";import{A as E,_ as ae,t as oe}from"./dist-DXAz3S6o.js";function D(e,n){m(n,!1),d();var r=K(),a=u(r);P(a,{name:`Message Types`,children:(e,n)=>{var r=H(),a=t(r),o=i(t(a),2),c=t(o);O(c,()=>`success`,()=>`Success`,()=>`Container started successfully`);var l=i(c,2);O(l,()=>`error`,()=>`Error`,()=>`Failed to start container: permission denied`);var u=i(l,2);O(u,()=>`warning`,()=>`Warning`,()=>`Container exited with non-zero status code`);var d=i(u,2);O(d,()=>`info`,()=>`Info`,()=>`Pulling image podman-desktop/ubuntu:latest`),v(o),v(a),v(r),s(e,r)},$$slots:{default:!0},parameters:{docs:{description:{story:`All message types in one view`}},__svelteCsf:{rawCode:`<undefined {...args}>
