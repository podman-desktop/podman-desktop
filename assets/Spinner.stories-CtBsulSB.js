...
{:else}
  <Spinner {...args} />
{/if}`}}});var k=n(z,2);I(k,{name:"Accessibility",args:{kind:"accessibility"},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'sizes'}
  <div class="flex flex-col gap-4">
    <div class="text-sm text-(--pd-content-text)">
      Sizes used across the app (values preserved exactly).
    </div>
...
{:else}
  <Spinner {...args} />
{/if}`}}});var B=n(k,2);I(B,{name:"Contexts",args:{kind:"contexts"},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'sizes'}
  <div class="flex flex-col gap-4">
    <div class="text-sm text-(--pd-content-text)">
      Sizes used across the app (values preserved exactly).
    </div>
...
{:else}
  <Spinner {...args} />
{/if}`}}}),g(T,m),te()}W.__docgen={data:[],name:"Spinner.stories.svelte"};const A=ae(W,ve),Ee=["Basic","Sizes","Accessibility","Contexts"],Le={...A.Basic,tags:["svelte-csf-v5"]},Re={...A.Sizes,tags:["svelte-csf-v5"]},Ne={...A.Accessibility,tags:["svelte-csf-v5"]},qe={...A.Contexts,tags:["svelte-csf-v5"]};export{Ne as Accessibility,Le as Basic,qe as Contexts,Re as Sizes,Ee as __namedExportsOrder,ve as default};
