import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{G as t,J as n,Mt as r,Ot as i,Pt as a,_t as o,c as s,ct as c,dn as l,h as u,in as d,it as f,jt as p,m,mn as h,ot as g,rn as _,st as v,vn as y,xn as b}from"./iframe-4aNcBx40.js";import{a as x,i as S,n as C,r as w,t as T}from"./create-runtime-stories-BQAUD23r.js";import{r as E}from"./ErrorMessage-D54X5MaL.js";import{t as ee}from"./dist-CyqMrl6p.js";function D(e,t){d(t,!1),u();var n=W(),i=r(n);A(i,{name:`Basic`,args:{tip:`this is a custom tooltip`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'placements'}
...
{/if}`}}});var f=a(l,2);A(f,{name:`Container/Class`,args:{kind:`container`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'placements'}
  <div class="bg-(--pd-content-card-bg) p-8">
    <div class="flex flex-col gap-4 text-(--pd-content-text)">
      <div class="text-sm font-semibold text-(--pd-content-text)">Placements</div>
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}}),g(e,n),_()}var O,k,A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{b(),x(),y(),ee(),S(),s(),C(),O=(e,s)=>{let c=()=>h(s?.(),[]);var u=v(),d=r(u),_=e=>{var n=I(),r=p(n),s=a(p(r),2);t(s,5,()=>j,e=>e.name,(e,t)=>{var n=F(),r=p(n),s=p(r,!0);l(r);var c=a(r,2);E(c,m(()=>o(t).args,{children:(e,t)=>{var n=P();g(e,n)},$$slots:{default:!0}})),l(n),i(()=>f(s,o(t).name)),g(e,n)}),l(s),l(r),l(n),g(e,n)},y=e=>{var t=L(),n=p(t),r=a(p(n),2);E(r,{top:!0,tip:M,children:(e,t)=>{var n=P();g(e,n)},$$slots:{default:!0}}),l(n),l(t),g(e,t)},b=e=>{var t=z(),n=p(t),r=a(p(n),2);E(r,{tipSnippet:e=>{var t=R();g(e,t)},children:(e,t)=>{var n=P();g(e,n)},$$slots:{tipSnippet:!0,default:!0}}),l(n),l(t),g(e,t)},x=e=>{var n=V(),r=p(n),s=a(p(r),2);t(s,1,()=>N,e=>e.lang,(e,t)=>{var n=B(),r=p(n),s=p(r,!0);l(r);var c=a(r,2);E(c,{top:!0,get tip(){return o(t).text},children:(e,t)=>{var n=P();g(e,n)},$$slots:{default:!0}}),l(n),i(()=>f(s,o(t).lang)),g(e,n)}),l(r),l(n),g(e,n)},S=e=>{var t=H(),n=p(t),r=a(p(n),2);E(r,{tip:`Top-right tooltip with container class applied`,topRight:!0,containerClass:`inline-flex`,class:`mb-[20px]`,children:(e,t)=>{var n=P();g(e,n)},$$slots:{default:!0}}),l(n),l(t),g(e,t)},C=e=>{var t=U(),n=p(t),r=a(p(n),2);E(r,m(c,{children:(e,t)=>{var n=P();g(e,n)},$$slots:{default:!0}})),l(n),l(t),g(e,t)};n(d,e=>{c().kind===`placements`?e(_):c().kind===`long`?e(y,1):c().kind===`snippet`?e(b,2):c().kind===`i18n`?e(x,3):c().kind===`container`?e(S,4):e(C,-1)}),g(e,u)},k={component:E,render:O,title:`Tooltip`,tags:[`autodocs`],argTypes:{kind:{table:{disable:!0}},tip:{control:`text`,description:`Text to show in the tooltip`,defaultValue:`This is a tooltip`},top:{control:`boolean`,description:`Flag the tooltip as being at the top`,defaultValue:!1},topLeft:{control:`boolean`,description:`Flag the tooltip as being at the top left`,defaultValue:!1},topRight:{control:`boolean`,description:`Flag the tooltip as being at the top right`,defaultValue:!1},right:{control:`boolean`,description:`Flag the tooltip as being at the right`,defaultValue:!1},bottom:{control:`boolean`,description:`Flag the tooltip as being at the bottom`,defaultValue:!1},bottomLeft:{control:`boolean`,description:`Flag the tooltip as being at the bottom left`,defaultValue:!1},bottomRight:{control:`boolean`,description:`Flag the tooltip as being at the bottom right`,defaultValue:!1},left:{control:`boolean`,description:`Flag the tooltip as being at the left`,defaultValue:!1}},parameters:{docs:{description:{component:`These are the stories for the \`Tooltip\` component.
Allow to display a tooltip at a given position (top, bottom, etc.).
Supports simple text tooltips and complex content using snippets.`}}}},{Story:A}=w(k),j=[{name:`Top`,args:{tip:`this is a custom top tooltip`,top:!0}},{name:`Top Left`,args:{tip:`this is a custom top left tooltip`,topLeft:!0}},{name:`Top Right`,args:{tip:`this is a custom top right tooltip`,topRight:!0}},{name:`Right`,args:{tip:`this is a custom right tooltip`,right:!0}},{name:`Bottom`,args:{tip:`this is a custom bottom tooltip`,bottom:!0}},{name:`Bottom Left`,args:{tip:`this is a custom bottom left tooltip`,bottomLeft:!0}},{name:`Bottom Right`,args:{tip:`this is a custom bottom right tooltip`,bottomRight:!0}},{name:`Left`,args:{tip:`this is a custom left tooltip`,left:!0}}],M=`This is a very long tooltip message that demonstrates how tooltips handle extended content. It can contain detailed information that users need to understand the context of the UI element.`,N=[{lang:`German`,text:`Dieser Container wurde erfolgreich gestartet und ist jetzt bereit, eingehende Netzwerkanfragen zu verarbeiten.`},{lang:`Finnish`,text:`Tämä säilö on käynnistetty onnistuneesti ja se on nyt valmis käsittelemään saapuvia verkkopyyntöjä.`},{lang:`English (long)`,text:`This container engine connection has been successfully established and is currently running with all configured network interfaces active.`}],P=c(`<span class="inline-flex h-5 w-5 items-center justify-center rounded-full border border-(--pd-tooltip-border) text-xs text-(--pd-tooltip-text)">i</span>`),F=c(`<div class="flex flex-col gap-2"><div class="text-xs text-(--pd-content-text)"> </div> <!></div>`),I=c(`<div class="bg-(--pd-content-card-bg) p-8"><div class="flex flex-col gap-4 text-(--pd-content-text)"><div class="text-sm font-semibold text-(--pd-content-text)">Placements</div> <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3"></div></div></div>`),L=c(`<div class="bg-(--pd-content-card-bg) p-8"><div class="flex flex-row items-center gap-2 text-(--pd-content-text)"><span>Long text tooltip example</span> <!></div></div>`),R=c(`<div class="flex flex-col gap-1 max-w-64"><div class="font-semibold">Custom snippet content</div> <div class="text-xs">Useful for richer tooltip layouts with multiple lines of information.</div></div>`),z=c(`<div class="bg-(--pd-content-card-bg) p-8"><div class="flex flex-row items-center gap-2 text-(--pd-content-text)"><span>Snippet tooltip content</span> <!></div></div>`),B=c(`<div class="flex flex-row items-center gap-2"><span class="w-32 text-xs text-(--pd-content-text)"> </span> <!></div>`),V=c(`<div class="bg-(--pd-content-card-bg) p-8"><div class="flex flex-col gap-6 text-(--pd-content-text)"><div class="text-sm font-semibold text-(--pd-content-text)">i18n text wrapping</div> <!></div></div>`),H=c(`<div class="bg-(--pd-content-card-bg) p-8"><div class="flex flex-row items-center gap-2 text-(--pd-content-text)"><span>Container/class example</span> <!></div></div>`),U=c(`<div class="bg-(--pd-content-card-bg) p-8"><div class="flex flex-row items-center gap-2 text-(--pd-content-text)"><span>Move mouse over the icon to see the tooltip</span> <!></div></div>`),W=c(`<!> <!> <!> <!> <!> <!>`,1),D.__docgen={data:[],name:`Tooltip.stories.svelte`},G=T(D,k),K=[`Basic`,`Placements`,`LongText`,`SnippetContent`,`I18nWrapping`,`ContainerClass`],q={...G.Basic,tags:[`svelte-csf-v5`]},J={...G.Placements,tags:[`svelte-csf-v5`]},Y={...G.LongText,tags:[`svelte-csf-v5`]},X={...G.SnippetContent,tags:[`svelte-csf-v5`]},Z={...G.I18nWrapping,tags:[`svelte-csf-v5`]},Q={...G.ContainerClass,tags:[`svelte-csf-v5`]}})))()}$();export{q as Basic,Q as ContainerClass,Z as I18nWrapping,Y as LongText,J as Placements,X as SnippetContent,K as __namedExportsOrder,k as default};