import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{G as t,J as n,Mt as r,Ot as i,Pt as a,_t as o,c as s,ct as c,dn as l,dt as u,h as d,in as f,it as p,jt as m,m as h,mn as ee,ot as g,rn as _,st as te,un as v,vn as y,xn as ne}from"./iframe-wHx3v6Ds.js";import{a as re,i as ie,n as b,r as x,t as S}from"./create-runtime-stories-D4tkc7FZ.js";import{C as ae,D as C,L as oe,N as w,O as T,_ as E,a as D,j as se,k as O,l as ce,o as le}from"./Icon-Bx7NwzOS.js";import{n as k,t as A}from"./Button-BCsbbKxI.js";import{r as j,t as M}from"./free-regular-svg-icons-BVuv8LiA.js";function N(e,t){f(t,!1),d();var n=U(),i=r(n);R(i,{name:`Basic`,args:{kind:`basic`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
...
{/if}`}}});var o=a(i,2);R(o,{name:`States`,args:{kind:`states`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
  <div class="bg-(--pd-content-card-bg) p-4">
    <div class="flex flex-col gap-4">
      <div class="text-sm font-semibold text-(--pd-content-header)">{groupKinds[args.kind].label}</div>
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}});var s=a(o,2);R(s,{name:`Icons`,args:{kind:`icons`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
  <div class="bg-(--pd-content-card-bg) p-4">
    <div class="flex flex-col gap-4">
      <div class="text-sm font-semibold text-(--pd-content-header)">{groupKinds[args.kind].label}</div>
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}});var c=a(s,2);R(c,{name:`Examples`,args:{kind:`examples`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
  <div class="bg-(--pd-content-card-bg) p-4">
    <div class="flex flex-col gap-4">
      <div class="text-sm font-semibold text-(--pd-content-header)">{groupKinds[args.kind].label}</div>
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}});var l=a(c,2);R(l,{name:`Patterns`,args:{kind:`patterns`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
  <div class="bg-(--pd-content-card-bg) p-4">
    <div class="flex flex-col gap-4">
      <div class="text-sm font-semibold text-(--pd-content-header)">{groupKinds[args.kind].label}</div>
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}});var u=a(l,2);R(u,{name:`Edge Cases`,args:{kind:`edges`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
  <div class="bg-(--pd-content-card-bg) p-4">
    <div class="flex flex-col gap-4">
      <div class="text-sm font-semibold text-(--pd-content-header)">{groupKinds[args.kind].label}</div>
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}});var p=a(u,2);R(p,{name:`Tabs`,args:{kind:`tabs`},parameters:{__svelteCsf:{rawCode:`{#if args.kind && groupKinds[args.kind]}
  <div class="bg-(--pd-content-card-bg) p-4">
    <div class="flex flex-col gap-4">
      <div class="text-sm font-semibold text-(--pd-content-header)">{groupKinds[args.kind].label}</div>
      <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
...
{/if}`}}}),g(e,n),_()}var P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{ne(),re(),y(),j(),oe(),k(),ie(),s(),b(),{fn:P}=__STORYBOOK_MODULE_TEST__,F=(e,s)=>{let c=()=>ee(s?.(),[]);var d=te(),f=r(d),_=e=>{var n=V(),r=m(n),s=m(r),d=m(s,!0);l(s);var f=a(s,2);t(f,5,()=>z[c().kind].variants,e=>e.name,(e,t)=>{var n=B(),r=m(n),s=m(r,!0);l(r);var c=a(r,2);A(c,h(()=>o(t).args,{children:(e,n)=>{v();var r=u();i(()=>p(r,o(t).args.content)),g(e,r)},$$slots:{default:!0}})),l(n),i(()=>p(s,o(t).name)),g(e,n)}),l(f),l(r),l(n),i(()=>p(d,z[c().kind].label)),g(e,n)},y=e=>{var t=H(),n=m(t);A(n,h(c,{children:(e,t)=>{v();var n=u();i(()=>p(n,c().content)),g(e,n)},$$slots:{default:!0}})),l(t),g(e,t)};n(f,e=>{c().kind&&z[c().kind]?e(_):e(y,-1)}),g(e,d)},I=P().mockName(`onclick`),L={component:A,render:F,title:`Button/Button`,tags:[`autodocs`],argTypes:{kind:{table:{disable:!0}}},args:{onclick:I},parameters:{docs:{description:{component:`These are the stories for the \`Button\` component.
