import{i as e}from"./preload-helper-xPQekRTU.js";import{Ft as t,It as n,Q as r,Rt as i,cn as a,dt as o,fn as s,ft as c,ln as l,nn as u,p as d,s as f,tn as p,ut as m,vn as h,xn as g,y as _}from"./iframe-B7TDp4GI.js";import{a as v,i as y,n as b,r as x,t as S}from"./create-runtime-stories-B2EkVLjw.js";import{n as C,t as w}from"./LinearProgress-LLw9t-XP.js";import{n as T,t as E}from"./ProgressBar-D9UAPLqh.js";function D(e,t){u(t,!1),_();var r=F(),a=n(r);A(a,{name:`Basic`,parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'pageHeader'}
...
{:else}
  <LinearProgress {...args} />
{/if}`}}});var o=i(a,2);A(o,{name:`Page Header`,args:{kind:`pageHeader`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'pageHeader'}
  <div class="flex flex-col gap-6">
    <div class="text-sm text-(--pd-content-text)">
      LinearProgress is used inside <code>Page.svelte</code> between the header and tab bar.
      It appears when the <code>inProgress</code> prop is set to <code>true</code>.
...
{:else}
  <LinearProgress {...args} />
{/if}`}}});var s=i(o,2);A(s,{name:`Form Page`,args:{kind:`formPage`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'pageHeader'}
  <div class="flex flex-col gap-6">
    <div class="text-sm text-(--pd-content-text)">
      LinearProgress is used inside <code>Page.svelte</code> between the header and tab bar.
      It appears when the <code>inProgress</code> prop is set to <code>true</code>.
...
{:else}
  <LinearProgress {...args} />
{/if}`}}});var c=i(s,2);A(c,{name:`Accessibility`,args:{kind:`accessibility`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'pageHeader'}
  <div class="flex flex-col gap-6">
    <div class="text-sm text-(--pd-content-text)">
      LinearProgress is used inside <code>Page.svelte</code> between the header and tab bar.
      It appears when the <code>inProgress</code> prop is set to <code>true</code>.
...
{:else}
  <LinearProgress {...args} />
{/if}`}}}),A(i(c,2),{name:`Comparison`,args:{kind:`comparison`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'pageHeader'}
  <div class="flex flex-col gap-6">
    <div class="text-sm text-(--pd-content-text)">
      LinearProgress is used inside <code>Page.svelte</code> between the header and tab bar.
      It appears when the <code>inProgress</code> prop is set to <code>true</code>.
