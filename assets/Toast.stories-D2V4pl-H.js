import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{$t as t,Bt as n,Ht as r,It as i,Tt as a,Ut as o,V as s,an as c,c as l,dt as u,gt as d,mt as f,on as p,pn as m,tt as h,wn as g,x as _,xn as v,yn as y,zt as b}from"./iframe-DeADu8g1.js";import{a as x,i as S,n as C,r as w,t as ee}from"./create-runtime-stories-CnfKWVgm.js";import{L as te,P as T,f as ne,g as E,t as D}from"./Icon-BB9KmX8P.js";import{r as re}from"./Button-Dku7X_BH.js";import{k as O,m as ie,t as ae}from"./dist-UpAWgtju.js";function k(e,t){p(t,!1),_();var r=q(),i=n(r);I(i,{name:`Message Types`,children:(e,t)=>{var n=oe(),r=b(n),i=o(b(r),2),a=b(i);A(a,()=>`success`,()=>`Success`,()=>`Container started successfully`);var s=o(a,2);A(s,()=>`error`,()=>`Error`,()=>`Failed to start container: permission denied`);var c=o(s,2);A(c,()=>`warning`,()=>`Warning`,()=>`Container exited with non-zero status code`);var l=o(c,2);A(l,()=>`info`,()=>`Info`,()=>`Pulling image podman-desktop/ubuntu:latest`),m(i),m(r),m(n),f(e,n)},$$slots:{default:!0},parameters:{docs:{description:{story:`All message types in one view`}},__svelteCsf:{rawCode:`<undefined {...args}>
