...
{/if}`}}}),i(h,n),q()}M.__docgen={data:[],name:"Button.stories.svelte"};const o=J(M,oa),Ta=["Basic","States","Icons","Examples","Patterns","EdgeCases","Tabs"],Ia={...o.Basic,tags:["svelte-csf-v5"]},Da={...o.States,tags:["svelte-csf-v5"]},Ka={...o.Icons,tags:["svelte-csf-v5"]},Wa={...o.Examples,tags:["svelte-csf-v5"]},wa={...o.Patterns,tags:["svelte-csf-v5"]},Aa={...o.EdgeCases,tags:["svelte-csf-v5"]},Ea={...o.Tabs,tags:["svelte-csf-v5"]};export{Ia as Basic,Aa as EdgeCases,Wa as Examples,Ka as Icons,wa as Patterns,Da as States,Ea as Tabs,Ta as __namedExportsOrder,oa as default};
