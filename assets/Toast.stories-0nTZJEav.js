import{i as e}from"./preload-helper-xPQekRTU.js";import{$ as t,It as n,Lt as r,Nt as i,Sn as a,St as o,Yt as s,b as c,dt as l,hn as u,lt as d,nn as f,pt as p,rn as m,s as h,un as g,yn as _,z as v,zt as y}from"./iframe-CzdmDzvb.js";import{a as b,i as x,n as ee,r as S,t as te}from"./create-runtime-stories-vzROAnoA.js";import{L as ne,P as C,f as re,g as w,t as T}from"./Icon-CCeDJ7qd.js";import{r as ie}from"./Button-CtyGlWlR.js";import{A as E,_ as ae,t as oe}from"./dist-Ci8ciRtl.js";function D(e,t){m(t,!1),c();var i=ce(),a=r(i);P(a,{name:`Message Types`,children:(e,t)=>{var r=H(),i=n(r),a=y(n(i),2),o=n(a);O(o,()=>`success`,()=>`Success`,()=>`Container started successfully`);var s=y(o,2);O(s,()=>`error`,()=>`Error`,()=>`Failed to start container: permission denied`);var c=y(s,2);O(c,()=>`warning`,()=>`Warning`,()=>`Container exited with non-zero status code`),O(y(c,2),()=>`info`,()=>`Info`,()=>`Pulling image podman-desktop/ubuntu:latest`),g(a),g(i),g(r),l(e,r)},$$slots:{default:!0},parameters:{docs:{description:{story:`All message types in one view`}},__svelteCsf:{rawCode:`<undefined {...args}>
