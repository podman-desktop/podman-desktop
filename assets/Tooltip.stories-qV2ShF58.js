import{n as e}from"./rolldown-runtime-DaJ6WEGw.js";import{At as t,Dt as n,Nt as r,Sn as i,W as a,at as o,gt as s,jt as c,m as l,nn as u,ot as d,p as f,pn as p,q as m,rn as h,rt as g,s as _,st as v,un as y,yn as b}from"./iframe-Vn6Bg4aT.js";import{a as x,i as S,n as C,r as w,t as T}from"./create-runtime-stories-BfyVzbSQ.js";import{r as E}from"./ErrorMessage-d3hpOdn3.js";import{t as D}from"./dist-vBeJXxA1.js";function O(e,t){h(t,!1),l();var n=H(),i=c(n);j(i,{name:`Basic`,args:{tip:`this is a custom tooltip`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'placements'}
...
{/if}`}}});var f=r(d,2);j(f,{name:`Container/Class`,args:{kind:`container`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'placements'}
  <div class="bg-(--pd-content-card-bg) p-8">
    <div class="flex flex-col gap-4 text-(--pd-content-text)">
      <div class="text-sm font-semibold text-(--pd-content-text)">Placements</div>
      <div class="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
