import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{J as t,Mt as n,Ot as r,P as i,Pt as a,Wt as o,_t as s,c,ct as l,dn as u,gn as d,h as f,in as p,it as m,jt as h,ot as g,rn as _,vn as v,xn as y}from"./iframe-4aNcBx40.js";import{a as b,i as x,n as S,r as C,t as ee}from"./create-runtime-stories-BQAUD23r.js";import{L as te,P as w,f as ne,g as T,t as E}from"./Icon-BQ6WVRmK.js";import{r as re}from"./Button-CcsdpcBe.js";import{D,m as ie,t as ae}from"./dist-CyqMrl6p.js";function O(e,t){p(t,!1),f();var r=q(),i=n(r);F(i,{name:`Message Types`,children:(e,t)=>{var n=U(),r=h(n),i=a(h(r),2),o=h(i);k(o,()=>`success`,()=>`Success`,()=>`Container started successfully`);var s=a(o,2);k(s,()=>`error`,()=>`Error`,()=>`Failed to start container: permission denied`);var c=a(s,2);k(c,()=>`warning`,()=>`Warning`,()=>`Container exited with non-zero status code`);var l=a(c,2);k(l,()=>`info`,()=>`Info`,()=>`Pulling image podman-desktop/ubuntu:latest`),u(i),u(r),u(n),g(e,n)},$$slots:{default:!0},parameters:{docs:{description:{story:`All message types in one view`}},__svelteCsf:{rawCode:`<undefined {...args}>
