...
{:else}
  <Spinner {...args} />
{/if}`}}}),l(S,r),te()}j.__docgen={data:[],name:"Spinner.stories.svelte"};const G=le(j,pe),Ne=["Basic","Sizes","Contexts"],Me={...G.Basic,tags:["svelte-csf-v5"]},Re={...G.Sizes,tags:["svelte-csf-v5"]},qe={...G.Contexts,tags:["svelte-csf-v5"]};export{Me as Basic,qe as Contexts,Re as Sizes,Ne as __namedExportsOrder,pe as default};
