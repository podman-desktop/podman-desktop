import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{J as t,Mt as n,Ot as r,P as i,Pt as a,Sn as o,Wt as s,_n as c,_t as l,c as u,ct as d,dn as f,h as p,in as m,it as h,jt as g,ot as _,rn as v,yn as y}from"./iframe-CLfrOPBT.js";import{a as b,i as x,n as S,r as C,t as ee}from"./create-runtime-stories-1kBB17qu.js";import{L as te,P as w,f as ne,g as T,t as E}from"./Icon-CvvowY7y.js";import{r as re}from"./Button-BYa0J3gX.js";import{k as D,m as ie,t as ae}from"./dist-ByvHSlw7.js";function O(e,t){m(t,!1),p();var r=q(),i=n(r);F(i,{name:`Message Types`,children:(e,t)=>{var n=U(),r=g(n),i=a(g(r),2),o=g(i);k(o,()=>`success`,()=>`Success`,()=>`Container started successfully`);var s=a(o,2);k(s,()=>`error`,()=>`Error`,()=>`Failed to start container: permission denied`);var c=a(s,2);k(c,()=>`warning`,()=>`Warning`,()=>`Container exited with non-zero status code`);var l=a(c,2);k(l,()=>`info`,()=>`Info`,()=>`Pulling image podman-desktop/ubuntu:latest`),f(i),f(r),f(n),_(e,n)},$$slots:{default:!0},parameters:{docs:{description:{story:`All message types in one view`}},__svelteCsf:{rawCode:`<undefined {...args}>
