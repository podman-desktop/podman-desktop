...
{:else}
  <Spinner {...args} />
{/if}`}}}),g(T,m),te()}W.__docgen={data:[],name:"Spinner.stories.svelte"};const A=ae(W,ve),Le=["Basic","Sizes","Accessibility","Contexts"],Re={...A.Basic,tags:["svelte-csf-v5"]},Ne={...A.Sizes,tags:["svelte-csf-v5"]},qe={...A.Accessibility,tags:["svelte-csf-v5"]},Me={...A.Contexts,tags:["svelte-csf-v5"]};export{qe as Accessibility,Re as Basic,Me as Contexts,Ne as Sizes,Le as __namedExportsOrder,ve as default};
