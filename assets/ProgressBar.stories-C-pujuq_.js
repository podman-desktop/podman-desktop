import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{G as t,J as n,Mt as r,Ot as i,Pt as a,Sn as o,_t as s,c,ct as l,dn as u,h as d,in as f,it as p,jt as m,m as h,mn as g,ot as _,rn as v,st as y,un as b,yn as x}from"./iframe-CLfrOPBT.js";import{a as S,i as C,n as w,r as T,t as E}from"./create-runtime-stories-1kBB17qu.js";import{n as D,t as O}from"./ProgressBar-Dt6vtWRv.js";function k(e,t){f(t,!1),d();var n=W(),i=r(n);M(i,{name:`Basic`,args:{progress:50},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'levels'}
...
{:else}
  <ProgressBar {...args} />
{/if}`}}});var u=a(l,2);M(u,{name:`Contexts`,args:{kind:`contexts`},parameters:{__svelteCsf:{rawCode:`{#if args.kind === 'levels'}
  <div class="flex flex-col gap-4">
    <div class="text-sm text-(--pd-content-text)">
      Determinate mode shows a filled bar with percentage text. Indeterminate mode shows an animated sweep.
    </div>
...
{:else}
  <ProgressBar {...args} />
{/if}`}}}),_(e,n),v()}var A,j,M,N,P,F,I,L,R,z,B,V,H,U,W,G,K,q,J,Y,X,Z,Q;function $(){return($=e((()=>{o(),S(),x(),D(),C(),c(),w(),A=(e,o)=>{let c=()=>g(o?.(),[`_children`]);var l=y(),d=r(l),f=e=>{var r=R(),o=a(m(r),2);t(o,5,()=>N,e=>e.label,(e,t)=>{var r=L(),o=m(r),c=m(o,!0);u(o);var l=a(o,2),d=m(l);O(d,{get progress(){return s(t).progress}}),u(l);var f=a(l,2),h=e=>{var n=I(),r=m(n,!0);u(n),i(()=>p(r,s(t).note)),_(e,n)};n(f,e=>{s(t).note&&e(h)}),u(r),i(()=>p(c,s(t).label)),_(e,r)}),u(o),u(r),_(e,r)},v=e=>{var r=B(),o=a(m(r),2);t(o,1,()=>F,e=>e.label,(e,t)=>{var r=z(),o=m(r),c=m(o,!0);u(o);var l=a(o,2),d=m(l);O(d,{get width(){return s(t).width},get height(){return s(t).height},progress:65}),u(l);var f=a(l,2),h=e=>{var n=I(),r=m(n,!0);u(n),i(()=>p(r,s(t).note)),_(e,n)};n(f,e=>{s(t).note&&e(h)}),u(r),i(()=>p(c,s(t).label)),_(e,r)}),u(r),_(e,r)},x=e=>{var r=V(),o=a(m(r),2);t(o,5,()=>P,e=>e.label,(e,t)=>{var r=L(),o=m(r),c=m(o);u(o);var l=a(o,2),d=m(l);O(d,{get progress(){return s(t).progress}}),u(l);var f=a(l,2),h=e=>{var n=I(),r=m(n,!0);u(n),i(()=>p(r,s(t).note)),_(e,n)};n(f,e=>{s(t).note&&e(h)}),u(r),i(()=>p(c,`progress=${s(t).label??``}`)),_(e,r)}),u(o),u(r),_(e,r)},S=e=>{var t=H(),n=a(m(t),2),r=m(n),i=a(m(r),2),o=m(i);O(o,{progress:50}),u(i),b(2),u(r);var s=a(r,2),c=a(m(s),2),l=m(c);O(l,{}),u(c),b(2),u(s);var d=a(s,2),f=a(m(d),2),p=m(f);O(p,{progress:75,"aria-label":`Downloading image`}),u(f),b(2),u(d),u(n),u(t),_(e,t)},C=e=>{var t=U(),n=m(t),r=a(m(n),2),i=a(m(r),2),o=m(i);O(o,{class:`items-center`,height:`h-1`,width:`w-20`,progress:42}),u(i),u(r),u(n);var s=a(n,2),c=a(m(s),2),l=a(m(c),2);O(l,{class:`items-center`,height:`h-1`,width:`w-20`,progress:42}),u(c),u(s);var d=a(s,2),f=a(m(d),2),p=a(m(f),2);O(p,{class:`items-center`,height:`h-1`,width:`w-20`}),u(f),u(d);var h=a(d,2),g=a(m(h),2),v=a(m(g),2);O(v,{progress:68}),u(g),u(h),u(t),_(e,t)},w=e=>{O(e,h(c))};n(d,e=>{c().kind===`levels`?e(f):c().kind===`dimensions`?e(v,1):c().kind===`rounding`?e(x,2):c().kind===`accessibility`?e(S,3):c().kind===`contexts`?e(C,4):e(w,-1)}),_(e,l)},j={component:O,render:A,title:`Progress/ProgressBar`,tags:[`autodocs`],argTypes:{progress:{control:{type:`number`,min:0,max:100,step:1},description:`Progress percentage (0-100). Undefined shows indeterminate animation.`},width:{control:`text`,description:`Tailwind width class for the bar`},height:{control:`text`,description:`Tailwind height class for the bar`},class:{control:`text`,description:`Additional CSS classes on the wrapper element`},kind:{table:{disable:!0}}},parameters:{docs:{description:{component:'Stories for the `ProgressBar` component from `packages/renderer`.\n\nA linear progress indicator supporting determinate (0-100% with percentage text)\nand indeterminate (animated sweep for unknown duration) modes. Used in the Task Manager\ntable and the bottom Status Bar.\n\n**Accessibility**: The inner bar uses `role="progressbar"`. Additional ARIA attributes\n(e.g. `aria-label`) can be passed and are spread onto the wrapper element.\n\n**Theming**: Uses CSS custom properties `--pd-progressBar-bg` and\n`--pd-progressBar-in-progress-bg` from the color registry.'}}}},{Story:M}=T(j),N=[{label:`Indeterminate`,progress:void 0,note:`progress=undefined`},{label:`0%`,progress:0},{label:`25%`,progress:25},{label:`50%`,progress:50},{label:`75%`,progress:75},{label:`100%`,progress:100}],P=[{label:`100/3`,progress:100/3,note:`Displays as 33%`},{label:`200/3`,progress:200/3,note:`Displays as 67%`},{label:`5/3`,progress:5/3,note:`Displays as 2%`},{label:`99.9`,progress:99.9,note:`Displays as 100%`}],F=[{label:`Default (w-36, h-2)`,width:`w-36`,height:`h-2`,note:`Component defaults`},{label:`Compact (w-20, h-1)`,width:`w-20`,height:`h-1`,note:`Used in Task Manager and Status Bar`},{label:`Wide (w-48, h-2)`,width:`w-48`,height:`h-2`},{label:`Full width (w-full, h-2)`,width:`w-full`,height:`h-2`}],I=l(`<code class="text-[10px] text-(--pd-content-text)"> </code>`),L=l(`<div class="flex flex-col gap-2 rounded border border-(--pd-content-divider) p-3"><div class="text-xs font-semibold text-(--pd-content-header)"> </div> <div class="py-2"><!></div> <!></div>`),R=l(`<div class="flex flex-col gap-4"><div class="text-sm text-(--pd-content-text)">Determinate mode shows a filled bar with percentage text. Indeterminate mode shows an animated sweep.</div> <div class="grid grid-cols-2 gap-4 sm:grid-cols-3"></div></div>`),z=l(`<div class="flex flex-col gap-2 rounded border border-(--pd-content-divider) p-4"><div class="text-xs font-semibold text-(--pd-content-header)"> </div> <div class="py-2"><!></div> <!></div>`),B=l(`<div class="flex flex-col gap-6"><div class="text-sm text-(--pd-content-text)">Width and height are Tailwind classes. The compact variant (w-20, h-1) is used in production.</div> <!></div>`),V=l(`<div class="flex flex-col gap-4"><div class="text-sm text-(--pd-content-text)">Percentage text uses <code>Math.round()</code> for display.</div> <div class="grid grid-cols-2 gap-4"></div></div>`),H=l(`<div class="flex flex-col gap-4"><div class="text-sm text-(--pd-content-text)">The inner bar element uses <code>role="progressbar"</code> with <code>aria-valuemin</code> and <code>aria-valuemax</code>. Determinate mode also sets <code>aria-valuenow</code>. Note: <code>aria-label</code> and other ARIA props land on the outer wrapper via <code>restProps</code>,
        not on the inner element with <code>role="progressbar"</code>.</div> <div class="grid grid-cols-2 gap-4 sm:grid-cols-3"><div class="flex flex-col gap-2 rounded border border-(--pd-content-divider) p-3"><div class="text-xs font-semibold text-(--pd-content-header)">Determinate</div> <div class="py-2"><!></div> <code class="text-[10px] text-(--pd-content-text) break-all">aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"</code></div> <div class="flex flex-col gap-2 rounded border border-(--pd-content-divider) p-3"><div class="text-xs font-semibold text-(--pd-content-header)">Indeterminate</div> <div class="py-2"><!></div> <code class="text-[10px] text-(--pd-content-text) break-all">aria-valuemin="0" aria-valuemax="100" (no aria-valuenow)</code></div> <div class="flex flex-col gap-2 rounded border border-(--pd-content-divider) p-3"><div class="text-xs font-semibold text-(--pd-content-header)">Custom aria-label</div> <div class="py-2"><!></div> <code class="text-[10px] text-(--pd-content-text) break-all">aria-label on wrapper, not on role="progressbar"</code></div></div></div>`),U=l(`<div class="flex flex-col gap-6 text-(--pd-content-text)"><div class="flex flex-col gap-2"><div class="text-sm font-semibold text-(--pd-content-header)">Task Manager table row</div> <div class="flex items-center gap-x-4 rounded border border-(--pd-content-divider) px-4 py-3"><div class="text-sm w-48 truncate">Pulling docker.io/library/nginx:latest</div> <div class="flex items-center gap-x-2"><!></div></div></div> <div class="flex flex-col gap-2"><div class="text-sm font-semibold text-(--pd-content-header)">Status bar indicator</div> <div class="flex items-center gap-x-2 rounded border border-(--pd-content-divider) px-3 py-2 text-xs bg-(--pd-content-card-bg)"><span class="max-w-32 text-ellipsis overflow-hidden whitespace-nowrap">Pulling nginx:latest</span> <!></div></div> <div class="flex flex-col gap-2"><div class="text-sm font-semibold text-(--pd-content-header)">Status bar indicator (indeterminate)</div> <div class="flex items-center gap-x-2 rounded border border-(--pd-content-divider) px-3 py-2 text-xs bg-(--pd-content-card-bg)"><span class="max-w-32 text-ellipsis overflow-hidden whitespace-nowrap">2 tasks running</span> <!></div></div> <div class="flex flex-col gap-2"><div class="text-sm font-semibold text-(--pd-content-header)">Extension install dialog</div> <div class="flex flex-col gap-2 rounded border border-(--pd-content-divider) p-4 bg-(--pd-content-card-bg)"><div class="text-sm">Installing extension from OCI image...</div> <!></div></div></div>`),W=l(`<!> <!> <!> <!> <!> <!>`,1),k.__docgen={data:[],name:`ProgressBar.stories.svelte`},G=E(k,j),K=[`Basic`,`ProgressLevels`,`Dimensions`,`Rounding`,`Accessibility`,`Contexts`],q={...G.Basic,tags:[`svelte-csf-v5`]},J={...G.ProgressLevels,tags:[`svelte-csf-v5`]},Y={...G.Dimensions,tags:[`svelte-csf-v5`]},X={...G.Rounding,tags:[`svelte-csf-v5`]},Z={...G.Accessibility,tags:[`svelte-csf-v5`]},Q={...G.Contexts,tags:[`svelte-csf-v5`]}})))()}$();export{Z as Accessibility,q as Basic,Q as Contexts,Y as Dimensions,J as ProgressLevels,X as Rounding,K as __namedExportsOrder,j as default};