import{i as e}from"./preload-helper-CT_b8DTk.js";import{At as t,Dt as n,N as r,Nt as i,Sn as a,Ut as o,at as s,gt as c,hn as l,jt as u,m as d,nn as f,q as p,rn as m,rt as h,s as g,st as _,un as v,yn as y}from"./iframe-D9qO9LWQ.js";import{a as b,i as x,n as S,r as C,t as ee}from"./create-runtime-stories-D5euUhO5.js";import{L as te,P as w,f as ne,g as T,t as E}from"./Icon-BKtjqJ82.js";import{r as re}from"./Button-BOP37RIu.js";import{A as D,_ as ie,t as ae}from"./dist-oc-kN6KF.js";function O(e,n){m(n,!1),d();var r=K(),a=u(r);F(a,{name:`Message Types`,children:(e,n)=>{var r=oe(),a=t(r),o=i(t(a),2),c=t(o);k(c,()=>`success`,()=>`Success`,()=>`Container started successfully`);var l=i(c,2);k(l,()=>`error`,()=>`Error`,()=>`Failed to start container: permission denied`);var u=i(l,2);k(u,()=>`warning`,()=>`Warning`,()=>`Container exited with non-zero status code`),k(i(u,2),()=>`info`,()=>`Info`,()=>`Pulling image podman-desktop/ubuntu:latest`),v(o),v(a),v(r),s(e,r)},$$slots:{default:!0},parameters:{docs:{description:{story:`All message types in one view`}},__svelteCsf:{rawCode:`<undefined {...args}>
